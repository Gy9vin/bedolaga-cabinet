...
## [1.59.0](https://github.com/Gy9vin/bedolaga-cabinet/compare/v1.58.0...v1.59.0) (2026-07-01)


### Features

* **a11y,i18n:** more modal focus-traps + Telegram theme/language sync ([0caba3d](https://github.com/Gy9vin/bedolaga-cabinet/commit/0caba3dffb34927fc1d9744dc5e51c3869675551))
* **a11y:** cross-platform hardening + modal focus-trap from impeccable audit ([8e0b63b](https://github.com/Gy9vin/bedolaga-cabinet/commit/8e0b63bac893485752a5837f2f82599dcf752702))
* **a11y:** dialog semantics + focus trap for the onboarding tour ([5c7d4b4](https://github.com/Gy9vin/bedolaga-cabinet/commit/5c7d4b4888c230ebf9595106b479194946bbae2d))
* **accounts:** разрешить отвязку email в разделе привязанных аккаунтов ([3baa822](https://github.com/Gy9vin/bedolaga-cabinet/commit/3baa8227d3d4dd02fc430517927d6b2815955381))
* add admin legal pages api client and display mode types ([e979aa8](https://github.com/Gy9vin/bedolaga-cabinet/commit/e979aa8863e32cd141722dbc1690fac12bfedeae))
* add Antilopay payment provider support ([7d94009](https://github.com/Gy9vin/bedolaga-cabinet/commit/7d940091fa2b7773eb0be9a7c3c7d48385253ac0))
* add Apple IAP (apple_iap) payment method support ([5888713](https://github.com/Gy9vin/bedolaga-cabinet/commit/58887138fcbe22863cde83d8bf24079ba7925a56))
* add AuraPay payment provider to cabinet frontend ([48827e4](https://github.com/Gy9vin/bedolaga-cabinet/commit/48827e430dfc4b499714b7183c9eeeba86456df5))
* add broadcast category selector (system/news/promo) in admin UI ([362a698](https://github.com/Gy9vin/bedolaga-cabinet/commit/362a69812fb57a8615750d367f73b3a29fda665b))
* add campaign/partner filters, delete_user action, and fix modal positioning in AdminBulkActions ([b01ffe3](https://github.com/Gy9vin/bedolaga-cabinet/commit/b01ffe33099a94e8b0f83e0f2ac700a6d24b696e))
* add display mode selector to info page editor ([04cbbb5](https://github.com/Gy9vin/bedolaga-cabinet/commit/04cbbb5e5182ee3996d62356917c7786132ea8ac))
* add Etoplatezhi payment provider support ([85a34b1](https://github.com/Gy9vin/bedolaga-cabinet/commit/85a34b1947c5e886bd363b57bae557c4fd6021c0))
* add Jupiter and Donut payment provider support ([7def847](https://github.com/Gy9vin/bedolaga-cabinet/commit/7def84718b30060580c732efdc7f1de4cc482786))
* add Lava payment provider support ([b4eb0fa](https://github.com/Gy9vin/bedolaga-cabinet/commit/b4eb0fa859b1c451acb27254939afa7bb8710737))
* add PayPear payment provider to cabinet frontend ([31ac511](https://github.com/Gy9vin/bedolaga-cabinet/commit/31ac511a09fa5f4f62f76b1147f71cae55b438de))
* add RollyPay payment provider to cabinet frontend ([770a580](https://github.com/Gy9vin/bedolaga-cabinet/commit/770a5803d6490199d5ee0dbc22863f8212245a4f))
* add subscription reissue button with cooldown timer ([f7cc445](https://github.com/Gy9vin/bedolaga-cabinet/commit/f7cc445127e010a8e1c1dd471459e87a85996cf5))
* add system pages admin section ([0d6a85a](https://github.com/Gy9vin/bedolaga-cabinet/commit/0d6a85a4f91ec07b1f87207e1502e30fbf3aeb2c))
* add TV Quick Connect to connection page for Android TV / Apple TV ([65f9493](https://github.com/Gy9vin/bedolaga-cabinet/commit/65f94931c59f081f663d0caefb316a2d15f3f27d))
* admin bulk actions page with TanStack Table ([1772d96](https://github.com/Gy9vin/bedolaga-cabinet/commit/1772d9632e868f1f780b5722b04b1954225d591f))
* **admin-remnawave:** add node/xray version icons like the panel ([1b1046b](https://github.com/Gy9vin/bedolaga-cabinet/commit/1b1046bb5c5caf43e55f3bb5915962a05319cc23))
* **admin-remnawave:** auto-refresh overview, responsive mobile grids, wide sub-requests ([ff3dbfa](https://github.com/Gy9vin/bedolaga-cabinet/commit/ff3dbfaa25c0a3bb08d2e16344b024fa659fcfab))
* **admin-remnawave:** enrich panel stats UI and fix nodes-online display ([b8be989](https://github.com/Gy9vin/bedolaga-cabinet/commit/b8be98939abb03ce9c8be24bc96890367c8443d3))
* **admin-remnawave:** meaningful icons for users-by-status cards ([7ca9c04](https://github.com/Gy9vin/bedolaga-cabinet/commit/7ca9c043ddfc5393efcd6c00fc5677d60b6dbe55))
* **admin-remnawave:** merge Traffic into Nodes as a per-node accordion ([6c9a77d](https://github.com/Gy9vin/bedolaga-cabinet/commit/6c9a77d419d7358308836efbe7614efad5932971))
* **admin-remnawave:** panel-style node rows with live metrics ([08f12da](https://github.com/Gy9vin/bedolaga-cabinet/commit/08f12daa400b0117d1502d260a405f4e9bd40f13))
* **admin-remnawave:** provider favicon, mobile node card, meaningful icons ([9309643](https://github.com/Gy9vin/bedolaga-cabinet/commit/9309643b7e200da10e6960e6a298d1dad26c7246))
* **admin-tickets:** deep-link to a specific ticket from notifications ([ff0b119](https://github.com/Gy9vin/bedolaga-cabinet/commit/ff0b119ebc02ecf053f568d53fc77363a31f1338))
* **admin-ui:** autopay status & last renewal in user card ([89cd90f](https://github.com/Gy9vin/bedolaga-cabinet/commit/89cd90f93d3e5d02cc8a7025652865d121e8a26e))
* **admin-ui:** horizontal bar chart of client app distribution (RemnaWave overview) ([d7cc48f](https://github.com/Gy9vin/bedolaga-cabinet/commit/d7cc48f8cb365e4174b294d0d09b02464db3be8c))
* **admin/broadcasts:** add preview buttons for Telegram + Email broadcasts ([d21c663](https://github.com/Gy9vin/bedolaga-cabinet/commit/d21c6637bf3a26fe7a6a7822eadc93b0de18de83))
* **admin/channels:** UI отчёта по подписчикам канала ([3f2d756](https://github.com/Gy9vin/bedolaga-cabinet/commit/3f2d756aa762348836dec7a7d9cfd63fae11b746))
* **admin/expiry-fallback:** кнопка «Прогнать expired в fallback» ([344d021](https://github.com/Gy9vin/bedolaga-cabinet/commit/344d021cf11aa547ff05e3db4bd35ccbd9766c70))
* **admin/settings:** добавить «Fallback при истечении» в дерево настроек ([b316032](https://github.com/Gy9vin/bedolaga-cabinet/commit/b3160325b28b39f1c60415de30d54b7903e391f1))
* **admin/users:** показывать DB ID в шапке карточки юзера ([e5fc6bb](https://github.com/Gy9vin/bedolaga-cabinet/commit/e5fc6bbc27372379fe9390d6b736334d5d9d18f1))
* **admin:** overpay certificate upload block ([f523604](https://github.com/Gy9vin/bedolaga-cabinet/commit/f52360449b5888026e45b8cecf34d2a10ebb0dad))
* **admin:** quick amounts editor in payment method settings ([bb8b823](https://github.com/Gy9vin/bedolaga-cabinet/commit/bb8b823b3778ac31538cb980c7323f7ca33d212a))
* **admin:** show common placeholders group in email template editor ([8b2501d](https://github.com/Gy9vin/bedolaga-cabinet/commit/8b2501d908b17a4f5402571da778e0cb793cc934))
* **admin:** UI привязки email/Telegram + merge users в AdminUserDetail ([badf0bc](https://github.com/Gy9vin/bedolaga-cabinet/commit/badf0bc0c491857896f67cb021652f40eb2d497d))
* **admin:** кнопка «Удалить старых EXPIRED» на странице fallback ([4202245](https://github.com/Gy9vin/bedolaga-cabinet/commit/4202245ca41ad808e9bf9a5d8f1408b1c2030876))
* **admin:** кнопка включения/выключения модема в карточке пользователя ([5eeb7b7](https://github.com/Gy9vin/bedolaga-cabinet/commit/5eeb7b7fe8129d90b954afb468ee37e96b0657e0))
* **admin:** страница управления fallback-сквадом ([34c81a0](https://github.com/Gy9vin/bedolaga-cabinet/commit/34c81a034c6455a4e03aabcfc6b1ccc6d66b355f))
* **antilopay:** inject apay-tag meta on cabinet boot ([6fa4afd](https://github.com/Gy9vin/bedolaga-cabinet/commit/6fa4afd5c1b67331a02127dc395476df1fbbd7e5))
* **auth,a11y:** Telegram CloudStorage token recovery + blocking-screen a11y ([f311602](https://github.com/Gy9vin/bedolaga-cabinet/commit/f31160208a5b5e872c78e8e0f5ee9a65d1a66928))
* **backgrounds:** add constellation background ([510e4bd](https://github.com/Gy9vin/bedolaga-cabinet/commit/510e4bd7383af7ac595f31cbe11eebbde5073792))
* **backgrounds:** add fireflies background ([1d00ca9](https://github.com/Gy9vin/bedolaga-cabinet/commit/1d00ca97e52db514083ca0a06ac54d33637b6625))
* **backgrounds:** add liquid-gradient background ([71160c6](https://github.com/Gy9vin/bedolaga-cabinet/commit/71160c670019ab7a5adaedf2beae4ea1e937d7cc))
* **backgrounds:** add matrix-rain background ([ab91c86](https://github.com/Gy9vin/bedolaga-cabinet/commit/ab91c86f81afa2166700ccc7dd9bde70a8d5ce7b))
* **backgrounds:** add snowfall background ([e3dbc4e](https://github.com/Gy9vin/bedolaga-cabinet/commit/e3dbc4e663419db99d391b43f2262af392a7528c))
* **backgrounds:** add starfield background with depth projection ([3742f2f](https://github.com/Gy9vin/bedolaga-cabinet/commit/3742f2f88df4d141ff344affed6844d6cea75815))
* **balance:** per-method quick amounts on top-up page ([25784db](https://github.com/Gy9vin/bedolaga-cabinet/commit/25784dbe181a515a3c340f086fda347f77b86031))
* **blocking:** account-deleted recovery screen with bot deep-link ([16b4711](https://github.com/Gy9vin/bedolaga-cabinet/commit/16b47119c9a5da682f43727d3b747cbd5f06593d))
* **broadcast-ui:** targeting by client app + refresh button ([68bd5d7](https://github.com/Gy9vin/bedolaga-cabinet/commit/68bd5d7f9f6a2878ab9b741e10f395ffa527cddf))
* **broadcasts:** show blocked-active users table per broadcast ([03722b8](https://github.com/Gy9vin/bedolaga-cabinet/commit/03722b83d05f6033f50259c2c42a8f65e8e8d63b))
* bulk actions — live progress, grant subscription, error details ([312e0b4](https://github.com/Gy9vin/bedolaga-cabinet/commit/312e0b492707a646fcb6f0ee71b1568389203043))
* bulk delete subscription + fix sub-rows showing for filtered single subs ([c726d3d](https://github.com/Gy9vin/bedolaga-cabinet/commit/c726d3d74e5990b7ad05d2453795000aedde7c78))
* bulk delete subscription protection for active paid subs ([afffab1](https://github.com/Gy9vin/bedolaga-cabinet/commit/afffab17d316bc7c37fde10cf6c125320b7828c6))
* **cabinet:** bulletproof Close button + kill the /login flash on the service-unavailable screen ([7413837](https://github.com/Gy9vin/bedolaga-cabinet/commit/7413837fafdf7346054b72bbd05a1c42c4e38bd2))
* **cabinet:** migrate all icons to the panel's Phosphor set ([d0e0b6b](https://github.com/Gy9vin/bedolaga-cabinet/commit/d0e0b6b7e3fd29a533636b397ed5021a75074615))
* **cabinet:** premium redesign of all 5 full-screen blocking states ([782568e](https://github.com/Gy9vin/bedolaga-cabinet/commit/782568e091fbe636c9f3136002f5b230089cdc04))
* **cabinet:** recoverable "service unavailable" screen when the backend is unreachable ([ac8a0fc](https://github.com/Gy9vin/bedolaga-cabinet/commit/ac8a0fc41aff4065fdf1dde0bbc47694bfd1f010))
* **connected-accounts:** email-merge confirmation via emailed one-time code ([3224320](https://github.com/Gy9vin/bedolaga-cabinet/commit/322432009502e6b983f286747e1d4840123fb7db))
* dedicated RBAC permissions for bulk actions, info pages, news ([ae55a18](https://github.com/Gy9vin/bedolaga-cabinet/commit/ae55a18fc9217f98e5bcbd6edde0d14b38884a7a))
* **desktop-header:** group nav into a centered segmented capsule ([7de9b3b](https://github.com/Gy9vin/bedolaga-cabinet/commit/7de9b3b51be095da15a9035c98d0aefa4b526838))
* devices in subscription rows, set_devices action, table columns ([5969c74](https://github.com/Gy9vin/bedolaga-cabinet/commit/5969c74f92a34d6f24ee005a4c1b9546bb4d660d))
* **devices:** inline rename UI for connected HWID devices ([321c65b](https://github.com/Gy9vin/bedolaga-cabinet/commit/321c65b68b70248e96ba102783c8af32e2686258))
* FAQ answer editor — replace textarea with TipTap rich editor ([0adbfa5](https://github.com/Gy9vin/bedolaga-cabinet/commit/0adbfa50eb0ff9021e4623b889b95f60e1200c8f))
* FAQ pages — Q&A builder in admin, accordion view for users ([1ee0f18](https://github.com/Gy9vin/bedolaga-cabinet/commit/1ee0f1834315195fca050bcc4e00ec988b703ffb))
* **gift:** branding header on post-payment & gift-claim pages + accurate telegram-invite copy ([f5ae634](https://github.com/Gy9vin/bedolaga-cabinet/commit/f5ae6347202ca95f07143aff72540d95bdca69f8))
* **gift:** transferable gift claim — buyer share link + recipient claim page ([db31d39](https://github.com/Gy9vin/bedolaga-cabinet/commit/db31d395cd70055da8b0cbf697fc70173b45401a))
* **google-migration:** API-клиент миграции Google → email+password ([e2401a6](https://github.com/Gy9vin/bedolaga-cabinet/commit/e2401a6ca7025d530cf1688494c33f0802067a48))
* **google-migration:** понятный статус тест-отправки на неактивный аккаунт ([0f7f5f0](https://github.com/Gy9vin/bedolaga-cabinet/commit/0f7f5f0aa73c0e08b47f5b359aec7ab0816598dc))
* **google-migration:** список не мигрировавших в кабинете ([b59f409](https://github.com/Gy9vin/bedolaga-cabinet/commit/b59f409e13a7653bc1d4b142980799034e7e6d74))
* **google-migration:** страница миграции Google в админке кабинета ([7509261](https://github.com/Gy9vin/bedolaga-cabinet/commit/7509261debe9a4e104aa8a3a5faaedd3d4001b05))
* **google-migration:** тест-отправка инвайта на один email в кабинете ([9d6bdae](https://github.com/Gy9vin/bedolaga-cabinet/commit/9d6bdaeba06145d08d8dc96f521ff15cc5058206))
* hide info tabs by display mode visibility ([39758a1](https://github.com/Gy9vin/bedolaga-cabinet/commit/39758a18b04c7af2bb0d629cda69e1b978196672))
* **icons:** add node/gift glyphs to the central barrel ([872f731](https://github.com/Gy9vin/bedolaga-cabinet/commit/872f73157faff53dc75d6689c1ea75d5e4150d6f))
* improve squad management UX — rename, swap icons, color gift button ([33f3264](https://github.com/Gy9vin/bedolaga-cabinet/commit/33f32648f0c070a26ad5c63532465448fa4c8f5c))
* info pages — tab replacement, custom pages on /info, responsive fixes ([6569469](https://github.com/Gy9vin/bedolaga-cabinet/commit/656946952a0351ad6071286b0e12f95e89782360))
* information pages — admin editor with TipTap, public viewer ([7d6d0ba](https://github.com/Gy9vin/bedolaga-cabinet/commit/7d6d0ba3442bf683b6c99d2af2b4b3fb287beb11))
* landing analytics goals, daily bar chart, referrer tracking, contact persistence ([020f4c9](https://github.com/Gy9vin/bedolaga-cabinet/commit/020f4c95e271d3f582cb907e9aeeef0fe7cc2353))
* **landing-stats:** rebuild charts on shared components + add funnel & breakdowns ([78c633f](https://github.com/Gy9vin/bedolaga-cabinet/commit/78c633ff548e893978f3bb7213475501a5562d56))
* **landing:** фолбэк на глобальную тему кабинета, когда у лендинга своя не задана ([0859583](https://github.com/Gy9vin/bedolaga-cabinet/commit/085958342e023ecf5811208644a1db54029ab67b))
* move email linking form into Connected Accounts page ([6fd0668](https://github.com/Gy9vin/bedolaga-cabinet/commit/6fd0668a243ed9ada8485586216e3956d35edc8e))
* multi-media attachments, linkify URLs, shared MessageMediaGrid ([6d3010b](https://github.com/Gy9vin/bedolaga-cabinet/commit/6d3010b6212f41a484dd507535d1dafa28a9160b))
* multi-select tariff filter, select-all subscriptions, auto-expand ([f13b723](https://github.com/Gy9vin/bedolaga-cabinet/commit/f13b7239a55fe0725ede4d1a34595179e073dcf8))
* multi-tariff bulk actions UI — subscription-level selection ([78b41dc](https://github.com/Gy9vin/bedolaga-cabinet/commit/78b41dc33802138941234d7cf0ef78616a6d92d3))
* per-method quick amounts, system pages admin, animated backgrounds overhaul ([47119c4](https://github.com/Gy9vin/bedolaga-cabinet/commit/47119c4c1fcb134a05845a71b29b6ec04648067e))
* **referral:** вернуть ссылку на бот рядом с ссылкой на кабинет ([61cf6e0](https://github.com/Gy9vin/bedolaga-cabinet/commit/61cf6e083cec6e6da1ec4faf3b4de67e1fd6b8bf))
* **sales-stats:** вкладка «Оплаты» — success-rate и неудачные покупки ([436d9f8](https://github.com/Gy9vin/bedolaga-cabinet/commit/436d9f860c89a4012c57a9689b11abdff1572332))
* **sales-stats:** дельты период-к-периоду на карточках сводки ([a685e54](https://github.com/Gy9vin/bedolaga-cabinet/commit/a685e542aa1e3863b25cac52af6e12edebc6e3c7))
* **sales-stats:** душевные карточки с иконками + фикс скачка при смене периода ([dfc7768](https://github.com/Gy9vin/bedolaga-cabinet/commit/dfc7768a403c9d8ff91a79cea8df9207b1855d8c))
* **sales-stats:** иконки на карточках во всех вкладках ([80ac631](https://github.com/Gy9vin/bedolaga-cabinet/commit/80ac63102b91a3aced5b3b599c5da05b6803bffa))
* **sales-stats:** карточки возвратов в сводке ([bd12113](https://github.com/Gy9vin/bedolaga-cabinet/commit/bd12113294c92379fc7fee6d4c25f1d73e3de856))
* **sales-stats:** конкретика в сводке ([3adda6f](https://github.com/Gy9vin/bedolaga-cabinet/commit/3adda6fa032e3d105b8b7836b478f68f4c5e6d9f))
* **sales-stats:** пресет «Этот месяц» (с 1-го числа) и он же по умолчанию ([9a05f23](https://github.com/Gy9vin/bedolaga-cabinet/commit/9a05f23a04358affca5faa0acb5cd81911372136))
* **sales-stats:** разбивка допов по пакетам тоже на BreakdownList ([bb97ee8](https://github.com/Gy9vin/bedolaga-cabinet/commit/bb97ee8430c6073ea872b08dea7733c0f9a46f27))
* **sales-stats:** читаемые разбивки и stacked-бары, иконки платёжек, выручка ([a75f42d](https://github.com/Gy9vin/bedolaga-cabinet/commit/a75f42d056afe7183cf070cf0d9e9cb88630f94a))
* second header checkbox for bulk subscription selection ([eeda567](https://github.com/Gy9vin/bedolaga-cabinet/commit/eeda567622e0ce17159c251f64126a9c2bc5d962))
* send campaign_slug during standalone email registration ([a46c89e](https://github.com/Gy9vin/bedolaga-cabinet/commit/a46c89e45ee9dee121b589f665330d9ce71483d2))
* show VPN connection info and subscription request history on admin user detail ([e1d2f8c](https://github.com/Gy9vin/bedolaga-cabinet/commit/e1d2f8cee403d895508f538ffbc6c9c528f92b05))
* smart CTA buttons after balance top-up ([cce2e82](https://github.com/Gy9vin/bedolaga-cabinet/commit/cce2e82f11ee91a5c3608bfb23bcb912997200f3))
* subscription selector in VPN connection block for multi-tariff ([bc37f31](https://github.com/Gy9vin/bedolaga-cabinet/commit/bc37f31350d9865918a8340273fccd4d76d4342f))
* **subscription:** баннер о fallback-скваде на странице подписки ([fa19ff9](https://github.com/Gy9vin/bedolaga-cabinet/commit/fa19ff9fd1a496e96e27370225925356fd1c97ba))
* **subscription:** инструкция подключения после покупки устройства ([2a607e5](https://github.com/Gy9vin/bedolaga-cabinet/commit/2a607e568fddc2223a40bc9f39bd29eb4323f4bd))
* **subscription:** предупреждения о невозврате при покупке/уменьшении устройств ([5f2d0b1](https://github.com/Gy9vin/bedolaga-cabinet/commit/5f2d0b15256ec2e2c8d763d0fc6de1f1d8e5b355))
* **support:** добавить помощник поддержки с навигацией по разделам ([ab09af0](https://github.com/Gy9vin/bedolaga-cabinet/commit/ab09af08471a92bc5875b65234f7c6fcb20846cd))
* **support:** инструкция после покупки устройств + памятка перед обращением ([945b751](https://github.com/Gy9vin/bedolaga-cabinet/commit/945b75148fd18e59094aee59e661a2fe0ac20504))
* **topup:** direct-open payment page when method.open_url_direct is set ([aa8bfc9](https://github.com/Gy9vin/bedolaga-cabinet/commit/aa8bfc9d0859bcbe31de60f7127e5e606e146316))
* **trial-card:** добавить альтернативу 'Сразу купить подписку' для платного триала ([b8ab75e](https://github.com/Gy9vin/bedolaga-cabinet/commit/b8ab75e8b3123cfdbd542b06248bb0b2ca009ee6))
* **trial-card:** показывать 'Сразу купить подписку' и для бесплатного триала ([22974dc](https://github.com/Gy9vin/bedolaga-cabinet/commit/22974dc3f8ee5ff8689cf8543031929a06bfe68c))
* **ui:** заменить все нативные date-инпуты на DateField ([016da9f](https://github.com/Gy9vin/bedolaga-cabinet/commit/016da9f638ca4a7ecec35e0d77c0e851bc3b8808))
* **ui:** тёмный DateField на react-day-picker вместо нативного input ([edd2d25](https://github.com/Gy9vin/bedolaga-cabinet/commit/edd2d25024989a0b2d7888b82fa2f13dce60b63e))
* **wheel:** UI бесплатных спинов и простых процентов ([946e639](https://github.com/Gy9vin/bedolaga-cabinet/commit/946e63945082eb7bf2cb9c98ca89fc13b232d67d))
* Yandex Metrika CID tracking, offline conversions UI, sticky pay button ([8005968](https://github.com/Gy9vin/bedolaga-cabinet/commit/80059681da8655daa4b79cf3451b87df661b9d1d))
* **yandex-conv:** forward CID through remaining paid API methods ([574da67](https://github.com/Gy9vin/bedolaga-cabinet/commit/574da67ca059427731dca6e0af69977cad746107))
* **yandex-conv:** forward CID through subscription purchase requests ([1b82280](https://github.com/Gy9vin/bedolaga-cabinet/commit/1b82280853d5938efeaf1d8517b937e8cbde5583))
* кнопка удаления подписки в админке кабинета ([b2bae76](https://github.com/Gy9vin/bedolaga-cabinet/commit/b2bae76de64a541707c0957604ec72f44274f90d))
* кнопка удаления подписки для active + предупреждение ([72fc909](https://github.com/Gy9vin/bedolaga-cabinet/commit/72fc9099fad3d853dda163a9518256b66c678663))
* кнопка удаления своих сообщений в тикетах ([d1b1e19](https://github.com/Gy9vin/bedolaga-cabinet/commit/d1b1e19be352d35c17b674b990c448333d580a9c))
* показывать срок подписки в карточке (1 мес, 3 мес, и т.д.) ([7c2299f](https://github.com/Gy9vin/bedolaga-cabinet/commit/7c2299ff4018a88170ea80ae3e4111faf260cfc4))
* штрафной сквад в дереве настроек кабинета ([a899804](https://github.com/Gy9vin/bedolaga-cabinet/commit/a899804da76caa6cf054c93160bb6b7ab61bb993))


### Bug Fixes

* 100% discount display + Telegram widget fix + sparkles icon ([300cb07](https://github.com/Gy9vin/bedolaga-cabinet/commit/300cb07c58d8f374abde47b861f4757e236d4eb0))
* **a11y:** announce form-level errors via role=alert in Login + ResetPassword ([92ec9c3](https://github.com/Gy9vin/bedolaga-cabinet/commit/92ec9c3c4288f409b2f280b2d2f47d4082ccb251))
* **a11y:** announce Login form-level error via role=alert ([7e9e51b](https://github.com/Gy9vin/bedolaga-cabinet/commit/7e9e51ba5a4d364413e2f47e09323ab0dc375d7d))
* **a11y:** aria-label on icon-only buttons (Subscription copy + InstallationGuide back/QR) ([9f06526](https://github.com/Gy9vin/bedolaga-cabinet/commit/9f065262385b8abf357fd8b3cff34e21b472bbc7))
* **a11y:** associate referral form labels with their inputs ([1b40c38](https://github.com/Gy9vin/bedolaga-cabinet/commit/1b40c3856d189be84ac8dfa60f5988b5fa8b805e))
* **a11y:** associate Support ticket form labels with their inputs ([90888db](https://github.com/Gy9vin/bedolaga-cabinet/commit/90888db48c0f620fb9ac223a31257416a1dd87d9))
* **a11y:** label associations for AdminCampaignCreate fields ([4d18be8](https://github.com/Gy9vin/bedolaga-cabinet/commit/4d18be848d8ad6174a3c81ffcb3959269ee24534))
* **a11y:** label associations for AdminCampaignEdit fields ([6f66cb6](https://github.com/Gy9vin/bedolaga-cabinet/commit/6f66cb67590b7fada4b6e79f875630c684380fed))
* **a11y:** label associations for AdminInfoPageEditor fields ([a489724](https://github.com/Gy9vin/bedolaga-cabinet/commit/a4897243ba7c8d046a485437e2e85d81b9b9c4a7))
* **a11y:** label associations for AdminNewsCreate fields ([fefc52f](https://github.com/Gy9vin/bedolaga-cabinet/commit/fefc52fb203ffc73c730ba3ebc7ae941440ec814))
* **a11y:** label associations for AdminPromocodeCreate fields ([a635ca2](https://github.com/Gy9vin/bedolaga-cabinet/commit/a635ca23161c3e2865e4f4f82a7e1e79bd283513))
* **a11y:** label associations for AdminPromoGroupCreate + AdminPinnedMessageCreate ([5a8195f](https://github.com/Gy9vin/bedolaga-cabinet/commit/5a8195f83fb78604af260fc127f4085742d3750f))
* **a11y:** label associations for AdminPromoOfferTemplateEdit fields ([1ec6d7e](https://github.com/Gy9vin/bedolaga-cabinet/commit/1ec6d7e9794b7630377065c7d1aa6ff02b9a1be5))
* **a11y:** label associations for AdminServerEdit fields ([d42fcfa](https://github.com/Gy9vin/bedolaga-cabinet/commit/d42fcfa5dd77a8663b1e4b761efe579f09328712))
* **a11y:** label associations for AdminTariffCreate fields ([e1b48c1](https://github.com/Gy9vin/bedolaga-cabinet/commit/e1b48c1ccb66ad44019c3fc4e537527b99dcd4d4))
* **a11y:** radiogroup semantics for AdminInfoPageEditor button groups ([30c4c2e](https://github.com/Gy9vin/bedolaga-cabinet/commit/30c4c2ecc67915df90c5eb5d0d1f5cd1233ca7cc))
* **a11y:** radiogroup semantics for AdminPromoOfferSend button groups ([581a2ff](https://github.com/Gy9vin/bedolaga-cabinet/commit/581a2ffb529f59bb8493a702ef2180cb4598b59b))
* **a11y:** radiogroup semantics for Campaign bonus-type selector ([27ba507](https://github.com/Gy9vin/bedolaga-cabinet/commit/27ba50747ac1fa6aab190560c4691a1284f9f8a7))
* **a11y:** switch semantics for admin form toggles ([7b0a72d](https://github.com/Gy9vin/bedolaga-cabinet/commit/7b0a72db5b4e13a5ddbb9e24bb405253501ebe5f))
* **a11y:** switch semantics for user-flow toggles ([491f48a](https://github.com/Gy9vin/bedolaga-cabinet/commit/491f48a331b80fa84e0ac82e3fd0341557adbff5))
* **account-linking:** email merge OTP — явный адрес назначения в i18n ([30f9f4e](https://github.com/Gy9vin/bedolaga-cabinet/commit/30f9f4e4de4a6f0da0cd2e3c92e4c488a20add5d))
* add back button to AdminBanSystem page ([f787cc2](https://github.com/Gy9vin/bedolaga-cabinet/commit/f787cc2de8de094965b83e04032723efe458eda9))
* add key prop to AnimatePresence, accessibility labels, remove hardcoded fallback ([7892630](https://github.com/Gy9vin/bedolaga-cabinet/commit/7892630e3bd4006e7f5dcd95d5e378c8a4d7e8f7))
* add Object.hasOwn polyfill for old iOS/Android WebViews ([7b0e6d8](https://github.com/Gy9vin/bedolaga-cabinet/commit/7b0e6d8bc8a3bfb0907c057cade17679a672f643))
* add paypear payment method description to ru/en locales ([5cbf29a](https://github.com/Gy9vin/bedolaga-cabinet/commit/5cbf29a1e89cf32dec2a4c5f1742be19573d5490))
* address review feedback on admin pages and backgrounds ([9e6372a](https://github.com/Gy9vin/bedolaga-cabinet/commit/9e6372afba53cfd51db50aac0e501df83b61e8bb))
* admin users search not working on pages beyond first ([fe609a5](https://github.com/Gy9vin/bedolaga-cabinet/commit/fe609a505b99ec54c76969e4eb7d35b4973243e9))
* **admin-bulk-actions:** plug stale-closure bug in columns useMemo ([7817243](https://github.com/Gy9vin/bedolaga-cabinet/commit/78172432539b66e3ed4d57dce708b6ce5dae0052))
* **admin-bulk-actions:** trap focus + label modal dialog (a11y) ([bc34e65](https://github.com/Gy9vin/bedolaga-cabinet/commit/bc34e65aace9bda183ca33360a36c2b9471726bb))
* **admin-remnawave:** add RAM/CPU icons to node metrics like the panel ([297d75a](https://github.com/Gy9vin/bedolaga-cabinet/commit/297d75a92c30d650c2a5eee4c3785b2365d6d094))
* **admin-remnawave:** lay node metrics in 3 fixed rows (processor/traffic/versions) ([43acb70](https://github.com/Gy9vin/bedolaga-cabinet/commit/43acb70ab96ad70b7f66f26db32b05f6dc18349f))
* **admin-remnawave:** node metrics 3-rows on mobile, original single row on desktop ([97d4367](https://github.com/Gy9vin/bedolaga-cabinet/commit/97d436721ac5c180fd82af40e1267ffd97deda9f))
* **admin-remnawave:** resolve provider favicon from site URL ([bd5e39f](https://github.com/Gy9vin/bedolaga-cabinet/commit/bd5e39fa56591a06ac94c5b6c6f095215c57ffe0))
* **admin-remnawave:** scope the mobile orphan-fill to small screens only ([493de23](https://github.com/Gy9vin/bedolaga-cabinet/commit/493de23a1dc678f33af7878dbc5cd981daebb3c5))
* **admin-remnawave:** truncate long tags in node traffic accordion ([1ef4b21](https://github.com/Gy9vin/bedolaga-cabinet/commit/1ef4b21614a10d23bd2531bc9e66a79414864c50))
* **admin-remnawave:** причесать иконки в карточках статистики ([7efe069](https://github.com/Gy9vin/bedolaga-cabinet/commit/7efe069be077a35e3538908d24bd68d11407d513))
* **admin-wheel:** unify prize-order banner buttons + drop hardcoded i18n fallbacks ([e4b3c86](https://github.com/Gy9vin/bedolaga-cabinet/commit/e4b3c8640bdbcf18430c736b8027abb51ce612cc))
* **admin-wheel:** unify statistics rendering + fill config UI gaps ([5de43c1](https://github.com/Gy9vin/bedolaga-cabinet/commit/5de43c1071aa1fabb63ce70989afde1e5f431059))
* **admin:** gate overpay certificate block by settings permission ([ecc2d45](https://github.com/Gy9vin/bedolaga-cabinet/commit/ecc2d45562b4e9ee43bf4b9b82976245ce872c8f))
* **admin:** harden legal pages editor state handling ([515c3d7](https://github.com/Gy9vin/bedolaga-cabinet/commit/515c3d73b8e60295653fbd5f0390d8e212e0a092))
* **admin:** rework email template editor ([#667043](https://github.com/Gy9vin/bedolaga-cabinet/issues/667043)) ([ac75a80](https://github.com/Gy9vin/bedolaga-cabinet/commit/ac75a806d93374313d8b65d77d6250c87c07a096))
* **admin:** show flag for every country code, not just hardcoded 25-36 ([f301d44](https://github.com/Gy9vin/bedolaga-cabinet/commit/f301d44f2443681b49d006e6a5be5eb8bad29ce9))
* **admin:** surface clipboard copy failures instead of swallowing ([576b4d5](https://github.com/Gy9vin/bedolaga-cabinet/commit/576b4d5601f4ee9d242786297390c7717337d733))
* align frontend bulk action types with backend API contract ([fc8170f](https://github.com/Gy9vin/bedolaga-cabinet/commit/fc8170fa1fab7cde102b26eea4c340276993eec1))
* allow saving 0% period discount in promo groups ([3a865a4](https://github.com/Gy9vin/bedolaga-cabinet/commit/3a865a472b60d3f85d68fa4a6adc935b6838b5fa))
* always send period_discounts in promo group updates ([d15c240](https://github.com/Gy9vin/bedolaga-cabinet/commit/d15c2408df2beeeecbce0f72a3911c003210ff11))
* **api:** глобальный axios timeout 30s → 90s ([abe2132](https://github.com/Gy9vin/bedolaga-cabinet/commit/abe2132c2280dc124cab10be078022bf9d33d410))
* **auth:** segment-aware endpoint matching to prevent Bearer-stripping on protected routes ([6c44a3b](https://github.com/Gy9vin/bedolaga-cabinet/commit/6c44a3b4075d18afa032d03c2c2d9ceca7ec2448))
* **auth:** send Bearer token for account merge endpoints ([6721e25](https://github.com/Gy9vin/bedolaga-cabinet/commit/6721e25df677caf4a13af349364eed5f1b70d85a))
* **backgrounds:** configurable wave colors and boxes grid color with explicit multicolor mode ([725bf8d](https://github.com/Gy9vin/bedolaga-cabinet/commit/725bf8df39bf71ab54a36289f40f9c2791334279))
* **backgrounds:** expose remaining hardcoded colors in shooting-stars, meteors, gradient-animation ([f1f4281](https://github.com/Gy9vin/bedolaga-cabinet/commit/f1f4281e119ca853fd12448541ac15bdb7f72f36))
* **backgrounds:** keep constellation particles in bounds on resize ([acd0d7c](https://github.com/Gy9vin/bedolaga-cabinet/commit/acd0d7c69e8252418e403c1dc97f6647c6c3756d))
* **backgrounds:** legacy config compatibility and locale sync ([caf499a](https://github.com/Gy9vin/bedolaga-cabinet/commit/caf499a824774fa0cfbb84c76a158872db58f224))
* **backgrounds:** live speed and size updates for fireflies ([3df2ef0](https://github.com/Gy9vin/bedolaga-cabinet/commit/3df2ef0f39391ed182d1b71b7dbd273970b62632))
* **backgrounds:** make beams and beams-collision colors configurable ([acbccc8](https://github.com/Gy9vin/bedolaga-cabinet/commit/acbccc8af802ec239381700df80ad83dea58f3a7))
* **backgrounds:** read aurora gradient colors and speed from settings ([66c08b5](https://github.com/Gy9vin/bedolaga-cabinet/commit/66c08b5d6d1431c93473eebd923ac71729f48d65))
* **balance:** align quick amounts edge cases with bot behavior ([9219885](https://github.com/Gy9vin/bedolaga-cabinet/commit/92198854b2efbc213d7bb4a951f85f249d9c9bb2))
* batch bug fixes matching backend changes ([e6f6713](https://github.com/Gy9vin/bedolaga-cabinet/commit/e6f6713b0e9b854d7eb88f4e2a53b26656637079))
* batch frontend fixes matching backend changes ([608a752](https://github.com/Gy9vin/bedolaga-cabinet/commit/608a75220f19bf64a956601c00fcec7bb974c41a))
* **blocking:** open bot deep-link via platform adapter, not window.open ([8c336d1](https://github.com/Gy9vin/bedolaga-cabinet/commit/8c336d16c72fef8ee062e01b9c2cf32a15c8c6f7))
* **broadcasts:** показывать «Партнёрка» вместо сырого ключа referrals в превью ([c24ae00](https://github.com/Gy9vin/bedolaga-cabinet/commit/c24ae0039cc554176aef2085606748d8e21ec3e5))
* **broadcasts:** честная метка + понятные пустые состояния списка заблокировавших ([b20f027](https://github.com/Gy9vin/bedolaga-cabinet/commit/b20f027b2561f1642abdcf78836f77cd4eb15202))
* **build:** drop redundant dynamic import of branding api ([7ae2787](https://github.com/Gy9vin/bedolaga-cabinet/commit/7ae2787596070b0a4cd3b323cdbf463cc14a1f2c))
* bulk actions — add tariff info to user list, fix tariff column display ([161fde4](https://github.com/Gy9vin/bedolaga-cabinet/commit/161fde430160a145cbc2c79a616676905d0242ad))
* bulk actions — modal touch targets, deleteFromPanel reset, remove dupe spacer ([161f630](https://github.com/Gy9vin/bedolaga-cabinet/commit/161f630fd8b8a361471b1e402d662d4ce8480cd5))
* bulk actions frontend — selectedUserIds mapping, debounce cleanup ([ebe9d9b](https://github.com/Gy9vin/bedolaga-cabinet/commit/ebe9d9be483f6fc58fd21009f8d14d989e7259b9))
* bulk progress log shows generic error instead of backend message ([8dd5e49](https://github.com/Gy9vin/bedolaga-cabinet/commit/8dd5e4985f60d1eb147130dea9be9ed9e5be34df))
* **bulk-actions:** drop unused ChevronDownIcon import ([a8df415](https://github.com/Gy9vin/bedolaga-cabinet/commit/a8df41593133133bafd0f14a4c78d70553a5b83c))
* **cabinet-icons:** correct two mismatched glyphs from the svg migration ([9aae399](https://github.com/Gy9vin/bedolaga-cabinet/commit/9aae399ce82b8bf95eb739e1406508f89a40b097))
* **cabinet:** blocking screens exit via the native Telegram back button, drop the in-page Close ([f9cc70c](https://github.com/Gy9vin/bedolaga-cabinet/commit/f9cc70cba32debc8edb300869ba652b93f774212))
* **cabinet:** equal-height StatCards so dashboard balance/referral align ([1a3236f](https://github.com/Gy9vin/bedolaga-cabinet/commit/1a3236f6506ffba87d65308a99b4cc0653b0d0ad))
* **cabinet:** harden global encoders against lone UTF-16 surrogates ([d37872f](https://github.com/Gy9vin/bedolaga-cabinet/commit/d37872fd4fa80d781377fc2b2169b3af22b77394))
* **cabinet:** Lava top-up return route + Telegram-unavailable card overflow ([d7f7bc7](https://github.com/Gy9vin/bedolaga-cabinet/commit/d7f7bc7c173817812193aa00b5b2215d2c87159b))
* **cabinet:** recover "Сервис недоступен" false-positive + top-up fixes ([16fad9f](https://github.com/Gy9vin/bedolaga-cabinet/commit/16fad9f4feae4323c181f8a3c1bb33e13071f82b))
* **cabinet:** remove duplicate buy button under trial offer + duplicate bot referral link ([2337977](https://github.com/Gy9vin/bedolaga-cabinet/commit/23379772015cad1cd6b4805d32469fc1b46a1b85))
* **cabinet:** show trial offer in multi-tariff mode ([7c10843](https://github.com/Gy9vin/bedolaga-cabinet/commit/7c10843d9c318c82c8525949c40ab94861041039))
* **cabinet:** stop long user data overflowing flex rows on mobile ([63863a0](https://github.com/Gy9vin/bedolaga-cabinet/commit/63863a048bf71793f08a560b26bb41cc3a24bdba))
* **cabinet:** sweep mobile flex-overflow across all pages + components ([800daf7](https://github.com/Gy9vin/bedolaga-cabinet/commit/800daf7506c1c1d1718971d672a8fabb38dfa8e8))
* **cabinet:** добавить импорт getPendingCampaignSlug в store/auth.ts ([ec7573e](https://github.com/Gy9vin/bedolaga-cabinet/commit/ec7573ebece6bad3dea06f186fa93bc7eb265dd8))
* campaigns/partners filter 422 — limit=200 exceeds backend max (100) ([5b1892d](https://github.com/Gy9vin/bedolaga-cabinet/commit/5b1892ddbb82cc45a28d3832c2db62aad59164be))
* change aurapay icon to pink gradient to avoid kassa_ai color collision ([996840f](https://github.com/Gy9vin/bedolaga-cabinet/commit/996840f62754a3871194841966c44a3c2f810a41))
* **chrome:** replace 2 platform emoji + 1 en-dash with on-brand tokens ([5784efd](https://github.com/Gy9vin/bedolaga-cabinet/commit/5784efd7a3d6aa789b16282c8c04259466363a37))
* complete is_limited status handling across all views ([1d5ce2d](https://github.com/Gy9vin/bedolaga-cabinet/commit/1d5ce2d4eac02d51604ae853b776c9c393732f02))
* complete sparkles icon in trial offer card (was showing only 1 of 3 sparkle paths) ([1cf9526](https://github.com/Gy9vin/bedolaga-cabinet/commit/1cf95267138908e2da79e1da3ebb25c2d0ae03be))
* **connected-accounts:** guide the user to enter the existing account's password when merging by email ([7d31dc3](https://github.com/Gy9vin/bedolaga-cabinet/commit/7d31dc3ffa094683c17b81dbf0ee8a555a34da09))
* **connected-accounts:** keep status/unlink inside the card on long IDs ([c39c164](https://github.com/Gy9vin/bedolaga-cabinet/commit/c39c164d51fac8616b994f87ba8bc027a4bf0726))
* **connected-accounts:** stack status + unlink so the full ID shows on mobile ([7383505](https://github.com/Gy9vin/bedolaga-cabinet/commit/7383505a127efc11b166d307eb2f06e1a70972e0))
* **connection:** happ cryptolink flow + ui fixes ([#385](https://github.com/Gy9vin/bedolaga-cabinet/issues/385)) ([c80e1af](https://github.com/Gy9vin/bedolaga-cabinet/commit/c80e1aff752d6d697cd6fedfbda6288c8e8e39cd))
* **connection:** Happ TV connect renders through the active block style (all 4) ([c91c9e0](https://github.com/Gy9vin/bedolaga-cabinet/commit/c91c9e0441232109398798d4c42711b1c897b5ed))
* **connection:** Happ TV connect works on Apple TV too (one API for both) ([ce7a3ea](https://github.com/Gy9vin/bedolaga-cabinet/commit/ce7a3eaedf4127129de2b2aec3dea85bd9fe48b1))
* **connection:** Happ TV quick-connect is Happ-only + matches config-block styles ([5855a88](https://github.com/Gy9vin/bedolaga-cabinet/commit/5855a88dc630924ea3e047ccb9cc85e578532b08))
* **connection:** keep selected app when switching platform ([f8ac489](https://github.com/Gy9vin/bedolaga-cabinet/commit/f8ac4895fa7def88d2e2905a8df57726f85aa048))
* **connection:** restrict Happ TV quick-connect to Android TV only ([ca54cb4](https://github.com/Gy9vin/bedolaga-cabinet/commit/ca54cb4732ee30cc18a851cd8a6b8b2301194014))
* **connection:** stop ERR_UNKNOWN_URL_SCHEME when opening app deep links on mobile ([325e221](https://github.com/Gy9vin/bedolaga-cabinet/commit/325e221e3209b430a7f5fd95df325802dae5db97))
* **dashboard:** show full name on welcome, fix gender mismatch on trial-expired card ([4de01cc](https://github.com/Gy9vin/bedolaga-cabinet/commit/4de01ccd1df913510aab2368552e6f993e7aa25f))
* **dashboard:** убрать дубль кнопки покупки при пустом списке подписок ([cecfe7e](https://github.com/Gy9vin/bedolaga-cabinet/commit/cecfe7ec038a26eb580404957e70859e0df27e26))
* **datepicker:** убрать скачки и поправить адаптив ([c880517](https://github.com/Gy9vin/bedolaga-cabinet/commit/c8805171693ec4070b9f9bc9b194b4ee91d971fa))
* **datepicker:** читаемость календаря в любой теме ([a8213ce](https://github.com/Gy9vin/bedolaga-cabinet/commit/a8213ce5d5fccd24ee192196a52accbf65954984))
* **decoration:** strip 4 accent / status-hue leaks across hero surfaces ([75f7750](https://github.com/Gy9vin/bedolaga-cabinet/commit/75f775064cfe50a140663b1498429a3f330b91da))
* **deeplink:** поддержать схему incy:// в редиректе добавления подписки ([488503b](https://github.com/Gy9vin/bedolaga-cabinet/commit/488503b360806def859e7792919b68ab29ae44e1))
* **desktop-header:** full-width row so all nav items fit (no overflow/overlap) ([864aeaf](https://github.com/Gy9vin/bedolaga-cabinet/commit/864aeaf600eb3af20f700af2c68f6570abbf1115))
* **desktop-header:** stop layout jumping via 3-column grid ([9fc681b](https://github.com/Gy9vin/bedolaga-cabinet/commit/9fc681b56da18c1453bc2e034d306019c454c771))
* **devices:** unicode escape bug + onSuccess race + en locale + apiErr surface ([d1e5ce8](https://github.com/Gy9vin/bedolaga-cabinet/commit/d1e5ce873b3dd1c3ede0c82c73f47f91346c0b04))
* differentiate rollypay icon from riopay (teal gradient, RY text) ([4eed0f3](https://github.com/Gy9vin/bedolaga-cabinet/commit/4eed0f358ed6f9c094602793ddfdb861a56da369))
* expand chevron invisible on accent background ([3801c36](https://github.com/Gy9vin/bedolaga-cabinet/commit/3801c3626aea5984f56f64a8d468f6a7e327fe35))
* FAQ answer editor — stable keys, safe setContent, drop handler ([a6850c8](https://github.com/Gy9vin/bedolaga-cabinet/commit/a6850c8cbca4e357993ccc9487953e972a33391e))
* **favicon:** скругляем углы кастомного лого как у плитки в хедере ([7104778](https://github.com/Gy9vin/bedolaga-cabinet/commit/71047780c96b72fe6af3bfca86e8e3b30eb2be9c))
* **flags:** render flag emoji on Windows globally via a scoped flag font ([b877d7f](https://github.com/Gy9vin/bedolaga-cabinet/commit/b877d7f17550aff9157e662af0525653ab764a0f))
* floating action bar covering pagination — add bottom spacer when selection active ([d43638b](https://github.com/Gy9vin/bedolaga-cabinet/commit/d43638b34e4ac701a81a0901de19ff77b2545473))
* floating action bar hidden behind mobile bottom nav — raise z-index + bottom padding ([c32bcfe](https://github.com/Gy9vin/bedolaga-cabinet/commit/c32bcfeb9e998408f20b72ba024195826af5f1da))
* **format:** convert price by exchange rate on landings and gift page ([6ffd0ae](https://github.com/Gy9vin/bedolaga-cabinet/commit/6ffd0ae824c3480beb4a2f6f6b2567953741f856))
* gift page shows only 1 tariff when tariffs have different periods ([e6403eb](https://github.com/Gy9vin/bedolaga-cabinet/commit/e6403eb7d0973f828d61f485fe98bc1a551b03c0))
* **gift:** cabinet GiftResult shows claim link for directed gifts + review fixes ([b9521f1](https://github.com/Gy9vin/bedolaga-cabinet/commit/b9521f1aa73758ad61d0d0be4686676c051dbe17))
* **gift:** stretch my-gifts cards full-width instead of cramped 2-col grid ([50d7d21](https://github.com/Gy9vin/bedolaga-cabinet/commit/50d7d2146296a30027306b02e01ce4177dc210e3))
* **gift:** working bot deep-link + desktop layout + barrel icons ([6ea7672](https://github.com/Gy9vin/bedolaga-cabinet/commit/6ea767253f88796f50a9e0aad8d5363033a0fba3))
* guard decodeURI(Component) against lone-surrogate crash ([#667225](https://github.com/Gy9vin/bedolaga-cabinet/issues/667225)) ([81581f5](https://github.com/Gy9vin/bedolaga-cabinet/commit/81581f5c9bdf119afb43e1b1d74ebcfa9934b86c))
* **i18n,a11y:** sync &lt;html lang&gt; + dir with i18n language ([28c6825](https://github.com/Gy9vin/bedolaga-cabinet/commit/28c682500ca84bba214c1b7d60868fac5ea33346))
* **i18n:** add missing broadcast preview locale keys ([7d29285](https://github.com/Gy9vin/bedolaga-cabinet/commit/7d29285ff6bc13a83080716b3c76c53530d908de))
* **i18n:** backfill 120 missing keys + close 2 typo regressions from purchase refactor ([e1f401c](https://github.com/Gy9vin/bedolaga-cabinet/commit/e1f401c333b992ab6476206fb231b608f8f20646))
* **i18n:** restore locale keys dropped during upstream merge ([5257b3e](https://github.com/Gy9vin/bedolaga-cabinet/commit/5257b3e625cd8a358eb4fe5e6c237bc2c70ce983))
* **i18n:** spell the brand "Remnawave" instead of camelCase "RemnaWave" ([0d024ae](https://github.com/Gy9vin/bedolaga-cabinet/commit/0d024aec58919882478da773083c93888ce23a00))
* **i18n:** убрать формулировку "бесплатно" в выборе устройств ([17692fd](https://github.com/Gy9vin/bedolaga-cabinet/commit/17692fdd95686913e858701f6c98488bcaffacaf))
* info page — slug collision guard, error resilience, overflow, loyalty responsive ([d6918ee](https://github.com/Gy9vin/bedolaga-cabinet/commit/d6918ee438cc89f0a405319049a8aa45d8555cda))
* info page editor — locale switch no longer resets user edits ([3ef54ad](https://github.com/Gy9vin/bedolaga-cabinet/commit/3ef54adb3eb8b3e50629805ed7ef9b53b10f8976))
* landing page currency symbol not changing with locale ([2d6815a](https://github.com/Gy9vin/bedolaga-cabinet/commit/2d6815a88e49b4a2f19a00d1e1003780ee93dad7))
* **landing-stats:** guard gift claim-rate against stale cache (avoid NaN%) ([b210a04](https://github.com/Gy9vin/bedolaga-cabinet/commit/b210a04dbb772fe1faf66f02b6ef6db447e9766e))
* **landing:** заголовок «Loading...» и пустая иконка вкладки на лендингах ([5a6e458](https://github.com/Gy9vin/bedolaga-cabinet/commit/5a6e4589c866a168656285deae214f178491cb12))
* limited (traffic exhausted) subscription shows as expired ([f68b466](https://github.com/Gy9vin/bedolaga-cabinet/commit/f68b46699c06accd6b47510ae9d6d3ca4da29817))
* load filters independently — one API failure no longer blocks others ([8e76744](https://github.com/Gy9vin/bedolaga-cabinet/commit/8e767443f080d184e60a5fec6be92a8b725913d1))
* make checkboxes visible on dark theme in bulk actions ([0844144](https://github.com/Gy9vin/bedolaga-cabinet/commit/0844144e23b635f7119b0ad92cbe9ea623612fc0))
* make subscription checkboxes same size as user checkboxes (h-5 w-5) ([9673f26](https://github.com/Gy9vin/bedolaga-cabinet/commit/9673f26469fa3d751c6d7cfe78e8001b7891885a))
* mobile/responsive issues in FAQ and info pages ([c16593a](https://github.com/Gy9vin/bedolaga-cabinet/commit/c16593aeeee4b993a1e3112019a98c122d6f34ee))
* move reissue button to standalone block outside device_limit guard ([60c8353](https://github.com/Gy9vin/bedolaga-cabinet/commit/60c835301d151f346028a35950081d4f72e247d3))
* multi-tariff filter now works server-side + trial-only checkbox ([98871af](https://github.com/Gy9vin/bedolaga-cabinet/commit/98871af6565adc51fa6892da3755704f9dd2c934))
* multi-tariff filter shows all users when &gt;1 tariffs selected ([efca40d](https://github.com/Gy9vin/bedolaga-cabinet/commit/efca40d9c8324760225e934c20d26e9b73da8a56))
* **navigation:** break BackButton loop on single-tariff /subscriptions/:id deep-link ([3c2f650](https://github.com/Gy9vin/bedolaga-cabinet/commit/3c2f650c28a7a47b12dcc19197cf1a6dd46f2b03))
* **navigation:** make Telegram back button work on deep-link entry ([2bcba3b](https://github.com/Gy9vin/bedolaga-cabinet/commit/2bcba3b60f883afc5fbad980fd067b0939a32069))
* **navigation:** single-tariff /subscriptions/:id deep-link shows Close, not Back ([0ed8bb1](https://github.com/Gy9vin/bedolaga-cabinet/commit/0ed8bb1d48918d7a441043b035c8cd0721f6c515))
* **navigation:** single-tariff subscription detail всегда Close, не Back ([ec346d3](https://github.com/Gy9vin/bedolaga-cabinet/commit/ec346d38d8e74a8efade19ac234c2f2261819747))
* **navigation:** надёжная кнопка «Назад» через тип навигации, без петли ([#436](https://github.com/Gy9vin/bedolaga-cabinet/issues/436)) ([a62d689](https://github.com/Gy9vin/bedolaga-cabinet/commit/a62d689fd39bea727b1bc9b13421775ca3a9c9a8))
* **nav:** keep Support pinned in mobile bottom-nav ([68a97b8](https://github.com/Gy9vin/bedolaga-cabinet/commit/68a97b896b4bc845bae49cf199198ca3d55a1ab3))
* **news:** fill the orphan card so the grid has no empty cell ([7b7ff53](https://github.com/Gy9vin/bedolaga-cabinet/commit/7b7ff536729872bc4b107bb4ce19a1643d979ca5))
* **onboarding:** prevent invisible overlay blocking clicks and stuck tour ([abbbc6a](https://github.com/Gy9vin/bedolaga-cabinet/commit/abbbc6a216f643a21131ebee0a34c638f3fbe777))
* **payment-labels:** добавить лейбл OverPay (показывался сырым ключом) ([33f8dda](https://github.com/Gy9vin/bedolaga-cabinet/commit/33f8ddac9a17047766ff924cefddf0e83e689cbf))
* **payments:** open_url_direct payment URL opens externally in Telegram ([#654272](https://github.com/Gy9vin/bedolaga-cabinet/issues/654272)) ([ce5737f](https://github.com/Gy9vin/bedolaga-cabinet/commit/ce5737fcbc44030595c0dc7a3cfda92e19aa2dbf))
* period discounts clearing, SBP default, happ cryptolink flow ([e6cf3af](https://github.com/Gy9vin/bedolaga-cabinet/commit/e6cf3af846090c0425a059d73a431eaa5f67ae0b))
* **permission-route:** guard against /admin → /admin redirect loop ([62eaef2](https://github.com/Gy9vin/bedolaga-cabinet/commit/62eaef2f539a33bf92d06c78421628f98974faaf))
* persist checkbox selection across page changes and filter switches ([cb148d1](https://github.com/Gy9vin/bedolaga-cabinet/commit/cb148d181a55b625c3fa09470b475b0db8f98615))
* **profile,connected-accounts:** drop dead ['user'] invalidate calls ([23e4e9b](https://github.com/Gy9vin/bedolaga-cabinet/commit/23e4e9b4d1854ce8f8ade8dd24249a5bdd232d2a))
* **profile:** use displayName helper for name field ([172850e](https://github.com/Gy9vin/bedolaga-cabinet/commit/172850e13a83f0ee57225985b46ffda84b4ba1a4))
* **promocode:** correct activation UX, error mapping and validity dates ([35428cc](https://github.com/Gy9vin/bedolaga-cabinet/commit/35428cc27d45335c11b8999391bd8a388090fe7b))
* prose content overflow on mobile — add overflow-x-auto ([596f638](https://github.com/Gy9vin/bedolaga-cabinet/commit/596f638cdd2d4fe69105685c6a65db871aef946d))
* **prose:** keep TipTap list markers inline with their content ([ed0b46e](https://github.com/Gy9vin/bedolaga-cabinet/commit/ed0b46e833d5d4bf8a1f94f2564890c6bab93f03))
* regenerate FAQ editor keys on locale switch ([5cfbce0](https://github.com/Gy9vin/bedolaga-cabinet/commit/5cfbce06638123f3b9429dda76d73c14ee6c704c))
* remove stale cabinet_last_login field from user detail ([8fcdbbe](https://github.com/Gy9vin/bedolaga-cabinet/commit/8fcdbbe53ef5de8392d752b3c05cb2e3ffadce3d))
* **reset-password:** cancel post-success redirect timer on unmount ([3f7320f](https://github.com/Gy9vin/bedolaga-cabinet/commit/3f7320fb4d6910c6d5f452a62699656ec9d3549c))
* restore cabinet_last_login in user detail (now shows real data) ([8044b66](https://github.com/Gy9vin/bedolaga-cabinet/commit/8044b664c36aea080b7ab8a84ba55aa48578a17e))
* **routing:** give every lazy page its own ErrorBoundary ([87e2e82](https://github.com/Gy9vin/bedolaga-cabinet/commit/87e2e82136785d4dc25c9052cb122ee4812f8034))
* **sales-stats:** «Выручка» → «Оборот по подпискам» во вкладке Продажи ([40c684c](https://github.com/Gy9vin/bedolaga-cabinet/commit/40c684cc8887df8ec6e2287939141a975e4aacbc))
* **sales-stats:** адаптив сетки Допов и сводки ([56d8e1f](https://github.com/Gy9vin/bedolaga-cabinet/commit/56d8e1ffa760558c0196cf1069a5696fe03dd0c9))
* **sales-stats:** крупные суммы сводки без копеек (короче, не режет) ([a687cc3](https://github.com/Gy9vin/bedolaga-cabinet/commit/a687cc3d1878eb22e12129e20b4e60158d62bfd2))
* **sales-stats:** не резать значения в карточках сводки (адаптив) ([631e922](https://github.com/Gy9vin/bedolaga-cabinet/commit/631e922f785bfaa0db396ea19df0dac886e2eb5b))
* **sales-stats:** ровные иконки в карточках + не дублировать иконку ([622ec31](https://github.com/Gy9vin/bedolaga-cabinet/commit/622ec318da6eac1cef92c95f244159825345a5e1))
* **sales-stats:** убрать пустые ячейки в сетках карточек ([54998c8](https://github.com/Gy9vin/bedolaga-cabinet/commit/54998c819566b749c282a5f20ab383469f2615ba))
* **scope-selector:** drop role=dialog from non-modal popover (a11y) ([bef984d](https://github.com/Gy9vin/bedolaga-cabinet/commit/bef984d72a534ac4296eaaf30e3cc01eb216e89e))
* scroll to device purchase section on buy devices click ([2a4dbea](https://github.com/Gy9vin/bedolaga-cabinet/commit/2a4dbeaee33aa1b1b02d89033f149896a55ddda7))
* **security+perf:** XSS-escaping в Info/AdminUpdates + polling guards ([f35d9f4](https://github.com/Gy9vin/bedolaga-cabinet/commit/f35d9f49a929a20d3d44394a5534c4811160a7f3))
* **security:** docker/infra hardening (MED) ([30226b7](https://github.com/Gy9vin/bedolaga-cabinet/commit/30226b711b757e2c6ff08c0a94a710839cf32468))
* **security:** escape list items + add CSP/security headers (HIGH) ([ae30972](https://github.com/Gy9vin/bedolaga-cabinet/commit/ae3097283f69fbd0f9c219765b307a96c24062dd))
* **security:** extract & reuse getSafeRedirectPath, plug TopUpAmount returnTo ([424a193](https://github.com/Gy9vin/bedolaga-cabinet/commit/424a19344dcfe0bbd8116a021283f67657dd0ca2))
* **security:** LOW bundle — iframe sandbox, deeplink validation ([0f62ef0](https://github.com/Gy9vin/bedolaga-cabinet/commit/0f62ef07c0c95751c5ee33c337810ed4925e4ab3))
* **security:** use signed media tokens for ticket attachments ([c6fc167](https://github.com/Gy9vin/bedolaga-cabinet/commit/c6fc167d80898832504000c24860be8c4099fb93))
* **security:** validate the deep-link url in miniapp/redirect.html (open redirect + DOM-XSS) ([b4f0669](https://github.com/Gy9vin/bedolaga-cabinet/commit/b4f066942a613027d8a9c347332ef1efdd29e03d))
* select-all subscriptions + per-page selector ([e2706c7](https://github.com/Gy9vin/bedolaga-cabinet/commit/e2706c7c265b16378fa0919cebc9f75648858eed))
* show API error details in menu editor save + allow tg:// URLs ([30d8d28](https://github.com/Gy9vin/bedolaga-cabinet/commit/30d8d28475298a6b620b682a7437022d3b818c80))
* show sub-rows for single-subscription users + fix floating bar position ([3cb1517](https://github.com/Gy9vin/bedolaga-cabinet/commit/3cb15177ccaab7c6451b42f80363694691464fe6))
* **stats-charts:** убрать focus-outline артефакт при клике по графику ([5e83762](https://github.com/Gy9vin/bedolaga-cabinet/commit/5e837621ad5649b8c6d78d74218cbee2258d0f2b))
* subscription status badge overflow + inline password validation ([3d0fc76](https://github.com/Gy9vin/bedolaga-cabinet/commit/3d0fc76ecda7c29c496ede51acaf931af53634e2))
* subscription tab not highlighted on detail pages ([e2f81ad](https://github.com/Gy9vin/bedolaga-cabinet/commit/e2f81ad28dd5caaee8d5b5a0796b4b78a6c36ace))
* **subscription:** clear critique P0 + P1 + part of P2 ([312a34f](https://github.com/Gy9vin/bedolaga-cabinet/commit/312a34f7159be3a836865a5120a7cc6f0640f699))
* **subscription:** forward subscription_id to purchaseTariff to fix renew race ([e44a093](https://github.com/Gy9vin/bedolaga-cabinet/commit/e44a09312edb936104ae9f4641f3e0452f275e79))
* **subscription:** hide strikethrough free label on device addon price ([1fdafbd](https://github.com/Gy9vin/bedolaga-cabinet/commit/1fdafbd0a1a5dbfc34b2ea9044d248487278a335))
* **subscription:** invalidate devices query after revoke ([47f0359](https://github.com/Gy9vin/bedolaga-cabinet/commit/47f0359ed657b49b294dc1f289e8bb18500a5778))
* **subscriptions:** «+ Купить ещё» только при платной подписке, явный CTA покупки ([39bfef5](https://github.com/Gy9vin/bedolaga-cabinet/commit/39bfef58d0db9ebbe2bd27d4e7f327f02932b81b))
* **subscriptions:** fill the orphan card so a lone subscription has no empty cell ([484c3ad](https://github.com/Gy9vin/bedolaga-cabinet/commit/484c3ad005616e16fc4280284048dcf674551057))
* **subscriptions:** дать новым юзерам путь в витрину без активации триала ([2d5982d](https://github.com/Gy9vin/bedolaga-cabinet/commit/2d5982d82bf8c47f13e07b230a800653d1eeed60))
* **subscription:** use the nav sparkle icon on the renew CTA button ([8613cb2](https://github.com/Gy9vin/bedolaga-cabinet/commit/8613cb20aa585c24e5d5e99f64e8b82efbbd8915))
* **subscription:** use the nav SubscriptionIcon on the quick-renew button ([5340f81](https://github.com/Gy9vin/bedolaga-cabinet/commit/5340f81a9562ad83a0a101d9f550ee30cf507622))
* **subscription:** use the sparkle icon on the quick-renew button ([e18db02](https://github.com/Gy9vin/bedolaga-cabinet/commit/e18db02e42214c8b2f6f54813815173417286134))
* **subscription:** обновить тексты предупреждений о невозврате устройств ([7cd99ec](https://github.com/Gy9vin/bedolaga-cabinet/commit/7cd99ecf739db4b5102eaff4b925cc09e7fcb4d2))
* **subscription:** уточнить что цена доп. устройства — за месяц ([5f99e0c](https://github.com/Gy9vin/bedolaga-cabinet/commit/5f99e0cd4eb4ac9eae4c69ab92d25796a2b3269b))
* support 100% discount display + fix Telegram link widget race condition ([207af81](https://github.com/Gy9vin/bedolaga-cabinet/commit/207af81c953eccb2e474cca47dfe9434e8a58527))
* **support-helper:** открывать контакт поддержки при выборе "Другой вопрос" ([1d4eead](https://github.com/Gy9vin/bedolaga-cabinet/commit/1d4eead265f652f71803a60e22568f3fbadc20a1))
* **support-helper:** памятка — мы видим онлайн статус, сообщения без деталей в последнюю очередь ([a9e60d2](https://github.com/Gy9vin/bedolaga-cabinet/commit/a9e60d20c231a85eec7c76a38f4d31a0a884ca8f))
* **support-helper:** порядок пунктов, deep link к секции устройств ([71fd65f](https://github.com/Gy9vin/bedolaga-cabinet/commit/71fd65f6594c7cb2b7b919faf00697363cb91110))
* switch component — replace motion with CSS transition-transform ([9b1e26d](https://github.com/Gy9vin/bedolaga-cabinet/commit/9b1e26d4ec146fa1a1e37dde2e9212e4edc5668b))
* **switch-tariff:** route trial & expired subs to the purchase flow ([#629889](https://github.com/Gy9vin/bedolaga-cabinet/issues/629889)) ([5b123f5](https://github.com/Gy9vin/bedolaga-cabinet/commit/5b123f5da034f22ed8d59700cf60d79213d4ea8c))
* **telegram-redirect:** cancel pending timers on effect re-run/unmount ([748b051](https://github.com/Gy9vin/bedolaga-cabinet/commit/748b0514ea6cba6424cd3054d93c201693ee7344))
* **theme:** readable text on any operator palette + admin consistency pass ([7f68e2c](https://github.com/Gy9vin/bedolaga-cabinet/commit/7f68e2cd5ef510faf54537e8b93c4450be854589))
* **theming:** replace off-token TelegramCallback/VerifyEmail with design tokens ([feee9f9](https://github.com/Gy9vin/bedolaga-cabinet/commit/feee9f9c05b2f872173ef6d4951bf2db8065514a))
* **toast:** drop side-stripe ban + a11y polish ([eaaf5cf](https://github.com/Gy9vin/bedolaga-cabinet/commit/eaaf5cfebbf90b9974712ae29f3a0334b6a08696))
* **topup:** preserve canonical RUB amount to avoid FX round-trip shortfall ([2a342f6](https://github.com/Gy9vin/bedolaga-cabinet/commit/2a342f6adc9ee4e2d0c157b69edc7213e1dc2d1b))
* **traffic:** correct misleading add-traffic note — 30-day validity ([f7bd36a](https://github.com/Gy9vin/bedolaga-cabinet/commit/f7bd36a95e27d9d9257fbfb45f23513b05a6b017))
* TypeScript null types в deleteSubscription ([53d8f68](https://github.com/Gy9vin/bedolaga-cabinet/commit/53d8f6808cd419b0ffde14c733be6b069cf54789))
* TypeScript ошибки в deleteSubscription ([fcc0a4e](https://github.com/Gy9vin/bedolaga-cabinet/commit/fcc0a4e5f44f82662927d12b9c6641bd60287c42))
* **ui:** finish design-audit follow-ups ([9456c7f](https://github.com/Gy9vin/bedolaga-cabinet/commit/9456c7f54eab9ab054472dd54cb527ec42a82571))
* user detail — separate request history sub selector, split mount effects ([853e1c9](https://github.com/Gy9vin/bedolaga-cabinet/commit/853e1c9c8477c028a7046e1c83c3089b00847cb9))
* validate counterId/conversionId before script injection (XSS prevention) ([a50bd39](https://github.com/Gy9vin/bedolaga-cabinet/commit/a50bd39df2fbc1fa994249ad24f1a02eb3f4ad8a))
* **wheel:** keep spin sparkles in the outer ring, never near the centre ([6c5d1ee](https://github.com/Gy9vin/bedolaga-cabinet/commit/6c5d1ee0b1cfb3329580879ce6b4be1c6c6a69ec))
* **wheel:** kill the center-line LED artifact during spin (drop CSS blur filter) ([8a41aa7](https://github.com/Gy9vin/bedolaga-cabinet/commit/8a41aa77819d141bc3e6cb6b481e2420b11f391e))
* **wheel:** remove CSS filters from the spinning SVG (kill GPU-composite streak) ([2ce966c](https://github.com/Gy9vin/bedolaga-cabinet/commit/2ce966cecec1c3a9634814cb1fb89a43d7ab63d9))
* **wheel:** remove the spin-only sparkle lights entirely ([bc85034](https://github.com/Gy9vin/bedolaga-cabinet/commit/bc8503469dc6651accb77f41b865e443849b75f2))
* **wheel:** scatter spin sparkles so they don't streak through the centre ([7716e32](https://github.com/Gy9vin/bedolaga-cabinet/commit/7716e32eecea6e43264342635090d8e4f68e4d87))
* **wheel:** stop showing fake wins in the browser ([73ee42a](https://github.com/Gy9vin/bedolaga-cabinet/commit/73ee42a0ef38ec36ff6f763304b9521e44d9302a))
* **wheel:** показывать «Бесплатно» в истории для free спинов ([2329120](https://github.com/Gy9vin/bedolaga-cabinet/commit/232912048b7d55c5c3240e71f4e5d108f839ee82))
* wrap server display names with Twemoji for cross-platform emoji rendering ([d75440b](https://github.com/Gy9vin/bedolaga-cabinet/commit/d75440bfe46e3c21d7207b9d823251857c86728e))
* админ удаление подписки через правильный endpoint ([42b3fe9](https://github.com/Gy9vin/bedolaga-cabinet/commit/42b3fe96bc653ffdd5a152dc8b90ebe3ad0fb43d))
* использовать end_date для расчёта оставшегося срока ([db26311](https://github.com/Gy9vin/bedolaga-cabinet/commit/db2631126045307779de29a65a8193e7e5e02fe8))
* показывать 1 мес / 3 мес / 6 мес / 1 год ([ab93ba1](https://github.com/Gy9vin/bedolaga-cabinet/commit/ab93ba1d31acc3e3f4796cc5bd550fcb6333de27))
* шаг 4 — после скачивания снова открыть ссылку, нажать в разделе скачанного приложения ([2657c1f](https://github.com/Gy9vin/bedolaga-cabinet/commit/2657c1fa6d31b9765d56508eec06caece5f4b3ec))
* шаг 4 инструкции — открыть ссылку и нажать «Добавить подписку» ([36878f3](https://github.com/Gy9vin/bedolaga-cabinet/commit/36878f369ccb68039c7fddeb5d1d6706cd5aa810))


### Performance Improvements

* **admin-bulk-actions:** migrate users + 4 lookup loaders to React Query ([bc5e95a](https://github.com/Gy9vin/bedolaga-cabinet/commit/bc5e95a6e55af44fa96f22facf4becee1e17131e))
* **admin-panel:** migrate system info + stats poll to React Query ([7426e1e](https://github.com/Gy9vin/bedolaga-cabinet/commit/7426e1e6d14a43f269c976954d33dece7c2ec19e))
* **admin-traffic:** migrate data flow to React Query ([2214d7f](https://github.com/Gy9vin/bedolaga-cabinet/commit/2214d7fdabb9bc1df9754627638b6ba16d5cf10b))
* **admin-user-detail:** migrate remaining 9 leaf loaders to React Query ([6f7bd10](https://github.com/Gy9vin/bedolaga-cabinet/commit/6f7bd10d61dc77b7bb9b035238df38c1001bbdf6))
* **admin:** migrate AdminBanSystem tab fetching to React Query ([1e4d6da](https://github.com/Gy9vin/bedolaga-cabinet/commit/1e4d6dad47ff4030d88a6594fa364513f6ada3d7))
* **admin:** migrate AdminDashboard to React Query (refetchInterval, no setInterval) ([0b07af8](https://github.com/Gy9vin/bedolaga-cabinet/commit/0b07af82d4e1c28f8153fb5bb44a5cc10627a1ad))
* **admin:** migrate AdminUserDetail loadUser to React Query (caching + cache key) ([5ee97e0](https://github.com/Gy9vin/bedolaga-cabinet/commit/5ee97e0a9f48fea1b267947c93c0d29585b59a43))
* **admin:** migrate AdminUsers fetch to React Query ([dadf08d](https://github.com/Gy9vin/bedolaga-cabinet/commit/dadf08d005cca5e22056ddef3e55106d646fc04f))
* **build:** split recharts + tiptap into dedicated vendor chunks ([7f14c49](https://github.com/Gy9vin/bedolaga-cabinet/commit/7f14c499ad61a7e74be638e5ca920c9951a3a01c))
* **images:** add loading=lazy to in-list previews and attachments ([b6613ae](https://github.com/Gy9vin/bedolaga-cabinet/commit/b6613ae4c92eb8ea02bf0375d419d6a510ddee99))
* **motion:** convert layout-property transitions to transforms ([eb13689](https://github.com/Gy9vin/bedolaga-cabinet/commit/eb13689ae79f9baddf973c1dc0a744913490f535))


### Reverts

* **sales-stats:** убрать карточки возвратов из сводки ([ec23618](https://github.com/Gy9vin/bedolaga-cabinet/commit/ec23618a56f0e1da3b140d2983edf10768000e30))
