...
* add sort by subscription expiry to user list ([89a9f9f](https://github.com/Gy9vin/bedolaga-cabinet/commit/89a9f9f70c5910916097818696711cb99ae19bcc))
...
* **admin-ui:** тумблер «Главный канал» (is_main) и показ последнего поста в AdminChannelSubscriptions ([db2a58e](https://github.com/Gy9vin/bedolaga-cabinet/commit/db2a58e654146e8ddaa4fad44dd3f9e118dd8fac))
* **admin:** add subscription timeline section to admin user detail ([2fbe6e8](https://github.com/Gy9vin/bedolaga-cabinet/commit/2fbe6e89bb7ee05e67b6cf42c2c8561f40f9dd1c))
...
* **admin:** бейдж «Команда» для команд бота в таймлайне активности ([f9ee16a](https://github.com/Gy9vin/bedolaga-cabinet/commit/f9ee16a2e67ed36b8672dd35b4a27d075743cc0a))
* **admin:** вкладка «Активность» в карточке пользователя ([7547b49](https://github.com/Gy9vin/bedolaga-cabinet/commit/7547b49d7a58745487693040537ddfb1bfa9dd43))
* **admin:** клики кнопок бота и действия в кабинете во вкладке «Активность» ([5fc8e7f](https://github.com/Gy9vin/bedolaga-cabinet/commit/5fc8e7f97a2f09f4d81ff17fa3914eacc7db58b7))
* **admin:** панельная идентичность под Remnawave 3.0.0 ([e840ed2](https://github.com/Gy9vin/bedolaga-cabinet/commit/e840ed2b60f5e525cb290ce5bddc70ef6dfe8a66))
* **admin:** предупреждение о разбивке длинных текстов системных страниц в боте ([93cfca4](https://github.com/Gy9vin/bedolaga-cabinet/commit/93cfca46dc133662329aa0ec8196f91f15ba4b3a))
* **admin:** статус и отмена СБП-автопродления в карточке юзера ([3328493](https://github.com/Gy9vin/bedolaga-cabinet/commit/332849393c00fa4f7e143af2b293a2775c0a4e8e))
* **api:** subscriptionApi.freeze/unfreeze + тип Subscription с freeze-полями ([b115fe5](https://github.com/Gy9vin/bedolaga-cabinet/commit/b115fe5018e4c73885ad5a10fce20caa3b690bba))
* **auth:** allow manual opt-in for deep-link Telegram login ([d03b9bd](https://github.com/Gy9vin/bedolaga-cabinet/commit/d03b9bdad785ac7710f30527f230eeb793e1089b))
* **auth:** чекбоксы согласия с офертой и политикой при первой авторизации ([0f21629](https://github.com/Gy9vin/bedolaga-cabinet/commit/0f21629ba516118790c5d7f65df18f485dfaeafe))
...
* **balance:** СБП-привязки в сохранённых методах ([d938ac2](https://github.com/Gy9vin/bedolaga-cabinet/commit/d938ac2dd9d9f9e27142ed578e17cc7d76ca4531))
* **branding:** загрузка видео стартового меню бота ([c9afea7](https://github.com/Gy9vin/bedolaga-cabinet/commit/c9afea7a5043e2a3b02d2242a116878fc70a0be6))
...
* **broadcasts:** поле icon_custom_emoji_id для кастомных кнопок рассылки ([b4b4bca](https://github.com/Gy9vin/bedolaga-cabinet/commit/b4b4bca2cb290c1be4ae4c076593200c686b72c5))
* **broadcasts:** поле icon_custom_emoji_id у кастомных кнопок рассылки ([eeb715c](https://github.com/Gy9vin/bedolaga-cabinet/commit/eeb715c09535a4e1d2489cd2c9d5969346718a26))
* **cabinet-ui:** попап нуджа подписки и свежего поста канала ([2ea63e1](https://github.com/Gy9vin/bedolaga-cabinet/commit/2ea63e1ab87407435615c55b72ed28cf6503e006))
* **cabinet:** api истории подписки (self + admin) + типы ([15160f6](https://github.com/Gy9vin/bedolaga-cabinet/commit/15160f612816c05a5292bd79f284b00b13c5d834))
...
* **cabinet:** legal footer on login + admin toggle ([984d1b0](https://github.com/Gy9vin/bedolaga-cabinet/commit/984d1b077616a352eb972daa02a9030545afc55e))
...
* **cabinet:** плашка резервного входа после оплаты подписки ([812b8b5](https://github.com/Gy9vin/bedolaga-cabinet/commit/812b8b5acc1c7ca03895b9c75ca66c70b456919b))
* **cabinet:** раздел «История подписки» в кабинете пользователя ([1413995](https://github.com/Gy9vin/bedolaga-cabinet/commit/14139953163db02964a609a6a9947b30f3067449))
* **cabinet:** форматтеры истории подписки (detailed/compact) + тесты ([8bb3e2d](https://github.com/Gy9vin/bedolaga-cabinet/commit/8bb3e2d224d85a6116f769a54f42c05d052bb8fd))
* **channel:** попап нуджа подписки и свежего поста + тумблер «Главный канал» ([27ce03a](https://github.com/Gy9vin/bedolaga-cabinet/commit/27ce03a8433862413001737730fc4f1ec9b6cedc))
...
* **coupons:** лимит на пользователя и удаление партии в кабинете ([390da33](https://github.com/Gy9vin/bedolaga-cabinet/commit/390da33914eb3f992719e33acf85decac660a880))
* **coupons:** раздел оптовых купонов + публичная страница активации ([799e986](https://github.com/Gy9vin/bedolaga-cabinet/commit/799e986d841aadf8a02ccc8287320a025e6a0aac))
* **dashboard:** плитка «Подключить устройство» на главной ([06c7d13](https://github.com/Gy9vin/bedolaga-cabinet/commit/06c7d1388308de5fc1adad0cd2697d3c03c41c49))
* **dashboard:** подключение устройства прикреплено к карточке подписки ([28e25a9](https://github.com/Gy9vin/bedolaga-cabinet/commit/28e25a92922501ed609623776e987fcd96f71032))
...
* **gift:** QR подарка и сканирование в кабинете ([0e4dc43](https://github.com/Gy9vin/bedolaga-cabinet/commit/0e4dc43335135fe229ce3c695fd7fa2722eb87e4))
...
* **gift:** показать предупреждение о конвертации суммы подарка в дни ([679fe02](https://github.com/Gy9vin/bedolaga-cabinet/commit/679fe02d6fa253d5aa06c545bb1b13b8a183d779))
...
* **landing:** автозаполнение поля контакта из параметра URL (?contact=...) ([8d0c33b](https://github.com/Gy9vin/bedolaga-cabinet/commit/8d0c33bb08b8f28b19367d1ea612a8455fba0ff1))
* **landing:** отправлять слаг рекламной кампании при гостевой покупке ([cfc2ab2](https://github.com/Gy9vin/bedolaga-cabinet/commit/cfc2ab2f7fe641570a818d0ca75c9cd9dddbf2b7))
* **landing:** отправлять слаг рекламной кампании при гостевой покупке ([d4379fc](https://github.com/Gy9vin/bedolaga-cabinet/commit/d4379fce25af69e866e9232a3cd036652e7eae17))
...
* **lava:** автопродление Lava на странице подписки ([2dce539](https://github.com/Gy9vin/bedolaga-cabinet/commit/2dce539da2a7c3128084ed2bc6bcdf560d440c75))
* **lava:** покупка привязкой, продукт тарифа в админке, CTA ([a28f116](https://github.com/Gy9vin/bedolaga-cabinet/commit/a28f1167f7af57bfc6e5c7c370849e7478ec459f))
* **legal:** wire recurrent-payments document + restore footer link ([20565b8](https://github.com/Gy9vin/bedolaga-cabinet/commit/20565b8f593f99533a016ae4706fc1030a8a8d57))
* **merge-panel:** add AdminMergePanel component with search + preview + confirm steps ([2300c2d](https://github.com/Gy9vin/bedolaga-cabinet/commit/2300c2dbe00a1722dee408909d99076b8f4be2aa))
* **merge-panel:** wire AdminMergePanel into AdminUserDetail ([7795013](https://github.com/Gy9vin/bedolaga-cabinet/commit/7795013db4bc0a851634874ab18ee3d0a8816c30))
* **merge:** add AdminMergePreviewResponse types + getMergePreview API, extend mergeUsers ([490a346](https://github.com/Gy9vin/bedolaga-cabinet/commit/490a3463a9b74e4cbb37ea5ecac6f0fff9cb415e))
* **merge:** redesign account-merge screen — choose the main account ([accb85d](https://github.com/Gy9vin/bedolaga-cabinet/commit/accb85dc2342a345a7a29feb3335ba27a7897333))
* **merge:** redesign MergeAccounts UI — choose survivor, show referrals and combined date ([1f1e4cc](https://github.com/Gy9vin/bedolaga-cabinet/commit/1f1e4cc4522cd09455e4b5bde4fcd4080b4f30c0))
* **merge:** update frontend types, API, and locales for keep_account ([7ba9b70](https://github.com/Gy9vin/bedolaga-cabinet/commit/7ba9b702f0eede6be6d20cd419d9e95229883096))
* **merge:** экран админ-объединения аккаунтов (AdminMergePanel) ([26c1d89](https://github.com/Gy9vin/bedolaga-cabinet/commit/26c1d89fb16667f92c6f8873bedda7e085fef5fa))
* **navigation:** startapp=trial → дашборд (оплата платного триала из rich-меню) ([c920330](https://github.com/Gy9vin/bedolaga-cabinet/commit/c920330fa606350c40c3ecaeb83651d5100b3f15))
* **navigation:** роутинг startapp-диплинков rich-меню бота ([2eaea75](https://github.com/Gy9vin/bedolaga-cabinet/commit/2eaea75fd93f1db3a0203ff308f365b11079cbc4))
* **payments:** способ оплаты cisPay ([4b98217](https://github.com/Gy9vin/bedolaga-cabinet/commit/4b982175d75f5d7d43312859cc061462b52f9570))
...
* **pricing:** в кабинете видно, из чего складывается цена ([435d0b4](https://github.com/Gy9vin/bedolaga-cabinet/commit/435d0b4d1b4976a17651d02752630c3eec1644fb))
* **promo-offers:** охват сегментов и прогресс доставки на странице отправки ([c6d8c0a](https://github.com/Gy9vin/bedolaga-cabinet/commit/c6d8c0afe0a30b864a9d0834735fdc7b52d8f362))
* **promocodes:** состав промокода чекбоксами — баланс / дни / промогруппа ([9ce838b](https://github.com/Gy9vin/bedolaga-cabinet/commit/9ce838badeda4dde45b16f38458e260a100fb39d))
* **promocodes:** трафик в наборе бонусов промокода ([f6a64bf](https://github.com/Gy9vin/bedolaga-cabinet/commit/f6a64bfc1eb885cde31bcbab1f1474b1d693e718))
* **referral-network:** кнопка построения полной реферальной сети ([19facf2](https://github.com/Gy9vin/bedolaga-cabinet/commit/19facf2ba968212ba9f1bb974ce886e9facc348f))
* **remnawave:** GeoCheck ноды в админке — запуск проверки и просмотр отчёта ([b4e1de6](https://github.com/Gy9vin/bedolaga-cabinet/commit/b4e1de6152cfc85418c62e4f840180411989a2a7))
...
* **sbp-recurring:** СБП-оформление подписки на форме покупки тарифа ([f448c14](https://github.com/Gy9vin/bedolaga-cabinet/commit/f448c149946cefee83e0e61f9c3c03b0d69a4362))
* **simple-sponsored:** оплата подписки другу в простом режиме ([1b916f6](https://github.com/Gy9vin/bedolaga-cabinet/commit/1b916f69f1119bcdb4f5e5c065d3c726a58f9469))
* **simple:** главная простого режима кабинета ([bbcf2a6](https://github.com/Gy9vin/bedolaga-cabinet/commit/bbcf2a6a60a78ad92b7ef57d3292a059c415c616))
* **simple:** история подписки простого режима ([9d73dec](https://github.com/Gy9vin/bedolaga-cabinet/commit/9d73dec4f9279054b547d42029e69cea99438263))
* **simple:** передача subscriptionId в freeze/unfreeze и гейтинг по дням ([3704d15](https://github.com/Gy9vin/bedolaga-cabinet/commit/3704d155c8f2d5aee4c0657eada683196a4b3994))
* **simple:** пополнение баланса простого режима ([1ee6110](https://github.com/Gy9vin/bedolaga-cabinet/commit/1ee611071d1ac77b3309ae67cd1cffeeb17b990e))
* **simple:** примитивы экранов простого режима ([ed73975](https://github.com/Gy9vin/bedolaga-cabinet/commit/ed739751071d09e56904acd1b507c6db7121c5b3))
* **simple:** профиль простого режима ([24154c9](https://github.com/Gy9vin/bedolaga-cabinet/commit/24154c9e0d904ad21b9949a9570109a6be5803fa))
* **simple:** рефералы простого режима ([52a469f](https://github.com/Gy9vin/bedolaga-cabinet/commit/52a469f36dab9497451775c95e85c1177f10804d))
* **simple:** тарифный режим экрана «Подписка» + Switch вместо самодельного тумблера ([43a6116](https://github.com/Gy9vin/bedolaga-cabinet/commit/43a6116fb632b8cddd00e0f945ddf63842bf1f54))
* **simple:** устройства и лимит устройств простого режима ([8518ff4](https://github.com/Gy9vin/bedolaga-cabinet/commit/8518ff43d2e314cdd05e7b493b2907ad5b9cb278))
* **simple:** экран подписки простого режима — покупка и продление одним экраном ([cb06b48](https://github.com/Gy9vin/bedolaga-cabinet/commit/cb06b48ba0dc6409715d214e90f3250babee2517))
* **simple:** экраны «Ждём оплату» и «Готово» после пополнения ([d518fdb](https://github.com/Gy9vin/bedolaga-cabinet/commit/d518fdbc90d1527b2529f79defe6e635d1c324a7))
* **sponsored:** экран оплаты подписки за другого человека ([7fb63a0](https://github.com/Gy9vin/bedolaga-cabinet/commit/7fb63a05435167cf3275268249610b881e272aff))
* **subscription:** API и утилиты СБП-автопродления Platega ([9093aec](https://github.com/Gy9vin/bedolaga-cabinet/commit/9093aec207bbc41e07433d55a90f9464c33a4b39))
* **subscription:** блок СБП-автопродления на странице подписки ([29a3683](https://github.com/Gy9vin/bedolaga-cabinet/commit/29a36837c8ad1310cce8fafa3e28f041c69a8d37))
* **subscription:** прятать кнопку перевыпуска по флагу SUBSCRIPTION_REVOKE_ENABLED ([50a0de1](https://github.com/Gy9vin/bedolaga-cabinet/commit/50a0de142795bb929b1543ff1d65b35e522e9337))
* **theme:** палитра макета простого режима как тема кабинета ([60d0b0d](https://github.com/Gy9vin/bedolaga-cabinet/commit/60d0b0da14cc0a4a7b16cf34792204b4781ea830))
* **timeline:** shared SubscriptionTimeline component + locale polish ([129127c](https://github.com/Gy9vin/bedolaga-cabinet/commit/129127c678d3bd9c58960e14bf644d55aa2477d1))
* **trial:** saveTrialCart + InsufficientBalancePrompt в TrialOfferCard ([d4ba27d](https://github.com/Gy9vin/bedolaga-cabinet/commit/d4ba27dfa668d320b933b04e621a4ee424a9b99d))
* **ui-mode:** переключатель интерфейса в профиле ([d8657d0](https://github.com/Gy9vin/bedolaga-cabinet/commit/d8657d0e7b1ccbdccd82c63d9d0e233015ea9da4))
* **ui-mode:** хук режима интерфейса с кэшем в localStorage ([459443e](https://github.com/Gy9vin/bedolaga-cabinet/commit/459443e4b5c1ea6c97e1c08c1e0782405449b9c5))
* **ui-mode:** четыре вкладки в простом режиме ([50eb72c](https://github.com/Gy9vin/bedolaga-cabinet/commit/50eb72ceaa7d1279e63e1e55595a9f55e5897e5b))
...
* **users:** кнопка «Отправить сообщение» в карточке пользователя ([2f743d8](https://github.com/Gy9vin/bedolaga-cabinet/commit/2f743d82dbb4d737fcb5f54dda5269271bae3de2))
* **users:** кнопка удаления подписки в карточке пользователя ([eafc563](https://github.com/Gy9vin/bedolaga-cabinet/commit/eafc563128b68f49f0a1f03a30c899b527ce4734))
* **ws:** уведомления о событиях СБП-автопродления ([e8409a9](https://github.com/Gy9vin/bedolaga-cabinet/commit/e8409a9007e25c685ceaa4b6a88c54237b02303a))
...
* **кабинет:** SimpleDashboard — статус «Заморожена», скрыть «Подключить устройство» ([df068b1](https://github.com/Gy9vin/bedolaga-cabinet/commit/df068b1cc995c31d1e290b1a3e2c83fc77d45587))
* **кабинет:** SimpleSubscription — заморозка подписки (задача 13) ([5272500](https://github.com/Gy9vin/bedolaga-cabinet/commit/52725001b74aec30c935492f003ce419a0c745eb))
...
* **admin-merge:** имя аккаунта в баннере, блокировка без выбора ссылки, удалён mergeV2, i18n для «до» ([8b865f8](https://github.com/Gy9vin/bedolaga-cabinet/commit/8b865f8dd1123145181021fb4f2e9f7271e3fd9e))
...
* **admin:** дополнить тип sort_by и китайскую строку сортировки ([2d6f8d9](https://github.com/Gy9vin/bedolaga-cabinet/commit/2d6f8d97546f7ca69540924aa0637f720500bef3))
* **admin:** дубликат ключа admin.paymentMethods.description ([46c1bc7](https://github.com/Gy9vin/bedolaga-cabinet/commit/46c1bc79a454c71b469a64f82f90a9585f265ab0))
* **admin:** окно объединения аккаунтов не помещалось в экран ([a6fd893](https://github.com/Gy9vin/bedolaga-cabinet/commit/a6fd893fcf12da763f253bfb0636c62fb2fa2080))
* **admin:** фиксированный телеграм-синий у свотча «Синий» вместо акцента темы ([62aaa5d](https://github.com/Gy9vin/bedolaga-cabinet/commit/62aaa5d7c9eaedb5a118469587a35585f9e4f549))
* align SubscriptionRequestRecord type with Remnawave 2.8.0 ([fd5500c](https://github.com/Gy9vin/bedolaga-cabinet/commit/fd5500c85badb95fce620267dff4574b7290258a))
* **auth:** make login footer legal links open real pages, not the login tab ([37a53e4](https://github.com/Gy9vin/bedolaga-cabinet/commit/37a53e40ea37cdba0882f98455d8b00bc9dde2d2))
...
* **auth:** share cabinet session across browser tabs (access token → localStorage) ([1a44ece](https://github.com/Gy9vin/bedolaga-cabinet/commit/1a44ece2ec7eaf1e4605ee274cfc70e453d885c9))
* **auth:** вернуть виджет после «Назад» и добить локали до четырёх ([c108832](https://github.com/Gy9vin/bedolaga-cabinet/commit/c1088325aabaf43de6f60653ff650c3cfb1beb2f))
* **auth:** кабинет терял сессию при бездействии ([161bc7b](https://github.com/Gy9vin/bedolaga-cabinet/commit/161bc7b7e82079879bed44808820b966824dbaef))
* **auth:** различать устаревшего бота и ненастроенного на экране логина ([b3b07c3](https://github.com/Gy9vin/bedolaga-cabinet/commit/b3b07c322de5ce48db83661a020dfe96be5b2237))
* **auth:** читать initData из моста Telegram, а не только из кэша SDK ([f81af40](https://github.com/Gy9vin/bedolaga-cabinet/commit/f81af401f7f6ca1a28806cbf237a33da7449d893))
...
* **blocking:** локализовать дефолтное сообщение на экране подписки на канал ([5e2e321](https://github.com/Gy9vin/bedolaga-cabinet/commit/5e2e3214c9e997896860f952aec774aecbbf49a4))
...
* **build:** вернуть build:docker, потерянный при мерже dev ([8af8232](https://github.com/Gy9vin/bedolaga-cabinet/commit/8af8232e2f4adfb3a4b4a31855219442e531601e))
...
* **cabinet:** cabinet referral link first; show Referral in bottom nav alongside Wheel ([92e5e20](https://github.com/Gy9vin/bedolaga-cabinet/commit/92e5e20e4a4c7c38ccc70a2c51d4ef7a667cb1b1))
...
* **cabinet:** восстановить корректный полифилл Object.hasOwn (регресс мержа) ([ead74c4](https://github.com/Gy9vin/bedolaga-cabinet/commit/ead74c43f27dc35241384c769af0a97bc7ea2b87))
* **channel-nudge:** финальные правки фронта — C1 подписка-показ, I1 24ч-троттл, I2 не блокировать ([71b5254](https://github.com/Gy9vin/bedolaga-cabinet/commit/71b525489a153699025c81f8b3c7d0386b06f9d5))
...
* **ci:** рабочий Trivy-пин, lowercase-референс образа, CodeQL v4 ([0a8b1a4](https://github.com/Gy9vin/bedolaga-cabinet/commit/0a8b1a46d134c88f0222987dd40707d85368ff5a))
...
* **connection:** keep the Happ add-subscription button working on Remnawave 2.8.0 ([8f31311](https://github.com/Gy9vin/bedolaga-cabinet/commit/8f31311112979beebeccf2952adcb8f2d4580fdd))
...
* **connection:** открывать deep-link приложения на iOS через top-level переход, а не iframe ([03aa2e6](https://github.com/Gy9vin/bedolaga-cabinet/commit/03aa2e6312ae602f087d30d7134020acb6338537))
* **dashboard:** не-суточная истёкшая подписка — выбор периода вместо мгновенного списания ([2fed58c](https://github.com/Gy9vin/bedolaga-cabinet/commit/2fed58cc994f1eafd3e543bcd93c58072e9a4462))
* **dashboard:** приветствие без пустого имени для email-пользователей ([147b1fb](https://github.com/Gy9vin/bedolaga-cabinet/commit/147b1fbb2e78bb8b3e0bd690568ea47c429c08c9))
* **dashboard:** счётчик устройств в плитке на главной ([39b9b8e](https://github.com/Gy9vin/bedolaga-cabinet/commit/39b9b8e1d2690c894ce08b0ce16d4780ecffee09))
...
* **devices:** безлимит устройств показывался как число, а не как «∞» ([6cab764](https://github.com/Gy9vin/bedolaga-cabinet/commit/6cab764955a2fe208e9985f20a9794df3ab006c4))
* **docker:** слушать IPv6 в nginx — healthcheck на localhost уводил контейнер в unhealthy ([a47e9ab](https://github.com/Gy9vin/bedolaga-cabinet/commit/a47e9ab6999a5da4d9574e3a00bb3ed18a461971))
* **docker:** слушать IPv6 в nginx — healthcheck на localhost уводил контейнер в unhealthy ([ce4ce04](https://github.com/Gy9vin/bedolaga-cabinet/commit/ce4ce046ba34b6439befda2899b87b77316c4030))
...
* **geocheck:** сквозные клики через портал и safe-зоны в полноэкранном режиме ([debe26a](https://github.com/Gy9vin/bedolaga-cabinet/commit/debe26ae359545fead38bf087b069e9defecec26))
* **geocheck:** скелетон до отрисовки отчёта и сброс зума на новом отчёте ([5c3031f](https://github.com/Gy9vin/bedolaga-cabinet/commit/5c3031f5f52e4a7bbe101441a97f5e47dd1eff3f))
* **geocheck:** убрать полноэкранный режим в Telegram Mini App ([5db1ffc](https://github.com/Gy9vin/bedolaga-cabinet/commit/5db1ffccf6a6659c06a1fbe5b2b703abd0c609bd))
* **geocheck:** убрать скачивание отчёта в Telegram Mini App ([a451a12](https://github.com/Gy9vin/bedolaga-cabinet/commit/a451a129fe0b211369f336f09f8c8e1abd105173))
...
* **header:** кэшировать список языков — переключатель не мигает при смене страницы ([a7ff8a6](https://github.com/Gy9vin/bedolaga-cabinet/commit/a7ff8a6b09281df2b971cddf30a95a4f8b774205))
...
* **i18n:** добавить недостающие английские переводы resetPassword и expiredDate_trial ([dd50d64](https://github.com/Gy9vin/bedolaga-cabinet/commit/dd50d648d069bb69db54d18d8e3bdf6bec965872))
* **i18n:** переименовать кнопку админ-слияния в «Объединить с другим аккаунтом» ([38466da](https://github.com/Gy9vin/bedolaga-cabinet/commit/38466da07c3108b1bea9826ac73d2a6c3243dfe7))
* **i18n:** починка плейсхолдеров и переводов в zh/fa/en локалях кабинета ([fb1f5cf](https://github.com/Gy9vin/bedolaga-cabinet/commit/fb1f5cf3a762f55f18806be97a0db973316ff6ad))
* **i18n:** существующие ключи вместо отсутствующих common.units.* на экране продления ([516399c](https://github.com/Gy9vin/bedolaga-cabinet/commit/516399cef9fa4a100b5dae979a04fafe0d05e634))
...
* **i18n:** форматировать даты и числа локалью выбранного языка, а не браузера ([81fd96c](https://github.com/Gy9vin/bedolaga-cabinet/commit/81fd96c2a758d8d092289dbaefa105b29f54137d))
...
* **landing:** не оставлять контакт из ссылки в адресной строке ([acbffa4](https://github.com/Gy9vin/bedolaga-cabinet/commit/acbffa4e17e4549a1068f286e3009b38d30ae6be))
* **merge:** gate combinedSubscription banner on active status, fix radiogroup aria-label ([190d4fe](https://github.com/Gy9vin/bedolaga-cabinet/commit/190d4fef0fbfc0ab921207d972d6d950466756e4))
...
* **nginx:** never cache index.html so redeploys reach browsers immediately ([85adceb](https://github.com/Gy9vin/bedolaga-cabinet/commit/85adcebbe1f89ba3b02029750b2d65200d0f34eb))
...
* **payment-methods:** admin display_name/description override locale on balance ([112e09b](https://github.com/Gy9vin/bedolaga-cabinet/commit/112e09bc6d1f0776f3f98602151a7730a8ed9245))
...
* **promocodes:** чекбоксы набора по значениям, трафик в списке ([29c9ed1](https://github.com/Gy9vin/bedolaga-cabinet/commit/29c9ed1a40bad95b187fabd81098a795d4c096da))
...
* **referral:** показывать секцию вывода средств всем реферерам ([ce13792](https://github.com/Gy9vin/bedolaga-cabinet/commit/ce13792f96547331f6a5093b7ff5b5ed32d840d9))
...
* **sbp-recurring:** toast ошибки отмены + per-sub ключ inline-confirm в админке ([42a7190](https://github.com/Gy9vin/bedolaga-cabinet/commit/42a71902418d3f5e8cd34c225442db40a9a1cf0d))
* **sbp-recurring:** компактный layout СБП-блока на десктопе ([faf4c45](https://github.com/Gy9vin/bedolaga-cabinet/commit/faf4c450b0e995e68fdce6f236a0a1a2de5e85c7))
* **sbp-recurring:** отступ между тогглом автопродления и СБП-блоком ([17e27d3](https://github.com/Gy9vin/bedolaga-cabinet/commit/17e27d343786e9b7e9e013d7c7e1d9e96de6e058))
...
* **security:** SRI для CDN-скрипта сканера QR ([b615927](https://github.com/Gy9vin/bedolaga-cabinet/commit/b615927283d9ae530c03f6120b3c5794d92e0689))
...
* **security:** внутренний гард openAppScheme от опасных схем (CodeQL) ([aa6bf44](https://github.com/Gy9vin/bedolaga-cabinet/commit/aa6bf44db9808aa79e0d711c0331e75171be75c0))
* **security:** инлайновые regex-барьеры для CodeQL в openAppScheme и redirect.html ([51d0f04](https://github.com/Gy9vin/bedolaga-cabinet/commit/51d0f0431a121ad179eb5b376fbab539018040dd))
* **settings:** вернуть в админку категории, которых не было в дереве ([653d683](https://github.com/Gy9vin/bedolaga-cabinet/commit/653d683835e2c10f7690f1f71df3552c3ba9ab2f))
* **simple-cabinet:** главная кнопка покупки вела в старый визард вместо нового экрана тарифов ([445edc0](https://github.com/Gy9vin/bedolaga-cabinet/commit/445edc06fe29cb4095af87cc0f6bc2a8bf9a7b75))
* **simple-dashboard:** доверстать главную по макету ([d4a00d8](https://github.com/Gy9vin/bedolaga-cabinet/commit/d4a00d87900dd17a61c8ce5f15820b2866259e34))
* **simple-dashboard:** исправить невалидный CSS-цвет замороженного индикатора ([cb921bb](https://github.com/Gy9vin/bedolaga-cabinet/commit/cb921bb849d619ab5fce59ba1b91036ef2a75969))
* **simple-devices:** доверстать экран «Устройства» по макету ([6b3300a](https://github.com/Gy9vin/bedolaga-cabinet/commit/6b3300aa9dfa76ba3422084a5f8c62039ad2baaf))
* **simple-history:** показывать цену каждого события ленты ([abb66b6](https://github.com/Gy9vin/bedolaga-cabinet/commit/abb66b648a5774ac88abea76a83771d885ec88b3))
* **simple-profile:** вернуть прямые действия для способов входа ([69ae358](https://github.com/Gy9vin/bedolaga-cabinet/commit/69ae35831c41eaa708f9315bd2022d74297219a8))
* **simple-referral:** добавить ссылку «Показать всех» под лентой ([a7ba6d2](https://github.com/Gy9vin/bedolaga-cabinet/commit/a7ba6d2af54faa86de463737462240ccd49e669d))
* **simple-subscription:** вернуть дату списания в подпись автопродления ([c290d42](https://github.com/Gy9vin/bedolaga-cabinet/commit/c290d42a8c4280a0303b46b8196bef5e26270e59))
* **simple-subscription:** подпись из чего сложилась цена в первой строке сводки ([0dd8b65](https://github.com/Gy9vin/bedolaga-cabinet/commit/0dd8b6558619a85f6912ff3a9cf3275b70748339))
* **simple-subscription:** расшифровка цены не рендерилась из-за поиска по английскому label ([e049508](https://github.com/Gy9vin/bedolaga-cabinet/commit/e049508e4a1cd0a60bdbdcd41257b1665939637d))
* **simple:** «Выбрать тариф» оформлен как акцентная ссылка ([591db40](https://github.com/Gy9vin/bedolaga-cabinet/commit/591db40d245f87ac97af1754af507214bb821ccb))
* **simple:** вернуть потерянные подписи на экранах лимита и оплаты ([1f27625](https://github.com/Gy9vin/bedolaga-cabinet/commit/1f276250616a827c62926375d39dd5ea1c7ca3ef))
* **simple:** доведение простого режима до 1:1 с макетом ([3656a20](https://github.com/Gy9vin/bedolaga-cabinet/commit/3656a208d4e369319f1d8cf7ddaab24748c81185))
* **simple:** дописать подписи устройств, рефералов, оплаты и истории ([62940d6](https://github.com/Gy9vin/bedolaga-cabinet/commit/62940d6df2998223f4272081cadbb2a05e6d4ee7))
* **simple:** не ставился флаг намерения перед пополнением из подписки ([add5f5f](https://github.com/Gy9vin/bedolaga-cabinet/commit/add5f5f2c0c7c47f1b2819c38fac45962ff0f9fd))
* **simple:** показывать год в дате, когда он не текущий ([ec157f3](https://github.com/Gy9vin/bedolaga-cabinet/commit/ec157f3e1ed5d65b780d24ff0d219d5a661b3dc4))
* **simple:** полностью убрать «Изменить трафик и страны» ([b01f530](https://github.com/Gy9vin/bedolaga-cabinet/commit/b01f53073a0de300b840e94fe399e4373e793416))
* **simple:** привести экраны к макету — рамки, таббар, брендинг, цены ([5f9ad61](https://github.com/Gy9vin/bedolaga-cabinet/commit/5f9ad61fec82a9a440b727163ee5c2f4118f8f47))
* **simple:** сверка текстов простого режима 1:1 с макетом ([9267ac6](https://github.com/Gy9vin/bedolaga-cabinet/commit/9267ac64932d95c54ea55ae7b553fe1c4b28e4fc))
* **simple:** скрывать «Изменить трафик и страны» при безлимите ([0510406](https://github.com/Gy9vin/bedolaga-cabinet/commit/0510406aa6537e4e9776d90b7e7b56dbb008b90e))
* **simple:** убрать QR из рефералов ([052bd8b](https://github.com/Gy9vin/bedolaga-cabinet/commit/052bd8b08ce3f07fa5cc35c95a3895126be9cba4))
* **simple:** четыре расхождения с макетом простого режима по скриншотам владельца ([0a6e699](https://github.com/Gy9vin/bedolaga-cabinet/commit/0a6e69942d57e754f16f217f7e2f6fceafe0c7a3))
* **simple:** экран пополнения не принимал сумму и способ из ссылки ([4438e91](https://github.com/Gy9vin/bedolaga-cabinet/commit/4438e91096e29c71ef9ee7ef5d9aa353dd74c378))
* **sponsored:** не показывать чужой баланс, авто-выбор периода и заглушка расшифровки цены ([9a58323](https://github.com/Gy9vin/bedolaga-cabinet/commit/9a5832361e7dfcfa3b68a541fa9ddb6d80dc0d71))
...
* **subscription:** fall back to purchase flow for free-tariff switches ([9f909b0](https://github.com/Gy9vin/bedolaga-cabinet/commit/9f909b0f2c22bf9c37ba4e0a74cf7dbaf36e5a02))
* **subscription:** fall back to purchase flow for free-tariff switches ([255777e](https://github.com/Gy9vin/bedolaga-cabinet/commit/255777e7d1db7af09963d397a187bf0d15cc5b39))
...
* **subscription:** корректная цена за месяц при выборе периода ([888a02f](https://github.com/Gy9vin/bedolaga-cabinet/commit/888a02f39722c68e4beddefbd1e39c402dfa51cb))
* **support:** не склеивать t.me со ссылкой на внешний хелпдеск ([f04675b](https://github.com/Gy9vin/bedolaga-cabinet/commit/f04675b2498abbbfb41ba48e0dd8cf7ee3a5a0a1))
* **support:** показывать пользователю отказ бэка при создании тикета ([d889289](https://github.com/Gy9vin/bedolaga-cabinet/commit/d88928912acaaf9eeee52235ee4e2aace5e245e7))
* **support:** ужесточить resolveSupportContact — схема, legacy-username, null ([ebde1f6](https://github.com/Gy9vin/bedolaga-cabinet/commit/ebde1f6174552ab4bef7f1fef8ef7950942781e7))
...
* **tariffs:** отправлять пустые промогруппы и описание при редактировании тарифа ([f1413de](https://github.com/Gy9vin/bedolaga-cabinet/commit/f1413de5984859e20a58e3212270ccd1495a6954))
...
* **theme:** выбранный акцент — реальный основной цвет (accent-500) ([87b8865](https://github.com/Gy9vin/bedolaga-cabinet/commit/87b886541dcf22d647fb41a07339764a03f95408))
* **theme:** монотонный рамп палитры (без чёрных и неоновых скачков) ([551b7d9](https://github.com/Gy9vin/bedolaga-cabinet/commit/551b7d9f4a94988029e1e533f9e4acb626852031))
* **tickets:** длинный текст в сообщении уезжал за пределы карточки ([eede5ff](https://github.com/Gy9vin/bedolaga-cabinet/commit/eede5ffdfdde9ece9956817c646ade36a9b2ccf6))
* **tickets:** длинный текст в сообщении уезжал за пределы карточки ([2ba6fc0](https://github.com/Gy9vin/bedolaga-cabinet/commit/2ba6fc0f6f743b8648c0d1e708cd123a465ee77f))
...
* **ui-mode:** переключатель режима не должен пропадать вместе с уведомлениями ([e0cd797](https://github.com/Gy9vin/bedolaga-cabinet/commit/e0cd797bb61b4d90684e7d73177d48845082e695))
* **ui-mode:** убрать побочный эффект из тела рендера в useUiMode ([1d119ca](https://github.com/Gy9vin/bedolaga-cabinet/commit/1d119cad8f8e759565102ae07d73a8b661916b59))
...
* **ui:** всплывающие окна вставали углом в центр экрана вместо середины ([19c24b6](https://github.com/Gy9vin/bedolaga-cabinet/commit/19c24b69113d0dd793a3cc59853b7916d2e801aa))
* **ui:** контент, пришедший из API после mount, оставался невидимым (stagger) ([adaaa23](https://github.com/Gy9vin/bedolaga-cabinet/commit/adaaa23da390ccdbc8938488fa9d36a00dc9c1db))
* **ui:** не перезапускать анимированный фон при смене страницы ([1ea9b99](https://github.com/Gy9vin/bedolaga-cabinet/commit/1ea9b99ab579f709db440b103cd37f93b92927ca))
* **ui:** нормализовать detail из ответов API перед рендером — краш на 422 ([9b97293](https://github.com/Gy9vin/bedolaga-cabinet/commit/9b972931cf8ea85f84538bf0b421df2730c4db66))
* **ui:** сдвиг страницы, мигание переключателя языка и перезапуск фона при SPA-навигации ([478a693](https://github.com/Gy9vin/bedolaga-cabinet/commit/478a6930198503ab93d9a2d2c5db0d6cbc5a84ef))
* **ui:** фиксированная ширина 100vw — страницы не сдвигаются при появлении скроллбара ([b40f939](https://github.com/Gy9vin/bedolaga-cabinet/commit/b40f939e914453d3080bde6051a7dbcf66a42321))
* **users:** показывать причину отказа при удалении подписки ([415a76f](https://github.com/Gy9vin/bedolaga-cabinet/commit/415a76f7cff4e0e06edb15b91a24467f0465e2e9))
